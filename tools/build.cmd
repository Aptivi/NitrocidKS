...
"%ProgramFiles%\dotnet\dotnet.exe" restore "..\Kernel Simulator.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
"%ProgramFiles%\dotnet\dotnet.exe" build "..\Kernel Simulator.sln" -p:Configuration=%releaseconfig% -maxCpuCount:1 %buildoptions%
