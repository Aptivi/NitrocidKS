...
**8/14/2020 - WIP - 0.0.12:** Updated SSH.NET Library, Added builtin configuration tool, Added permanent permission support, Removed CI command-line args, Added settings support for screensavers, Improved script execution logic, 
