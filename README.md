...
**5/6/2020 - WIP - 0.0.10:** Updated libraries, Fixed mods not being able to access the Encryption class, Simplified encryption code for mods, improved list of filesystems, fixed FTP crash when faced with multiple profiles, Now FTP addresses starting with ftpes:// will also be accepted
