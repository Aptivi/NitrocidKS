...
namespace Nitrocid.ScreensaverPacks.Screensavers
{
    ...
    public static class StarfieldWarpSettings
    {
        ...
        public static int StarfieldWarpDelay
        {
            get
            {
                return Config.SaverConfig.StarfieldWarpDelay;
            }
            set
            {
                if (value <= 0)
                    value = 10;
                Config.SaverConfig.StarfieldWarpDelay = value;
            }
        }
    ...
    public class StarfieldWarpDisplay : BaseScreensaver, IScreensaver
    {
        ...
        private readonly List<(double, double, int, int, double, double)> Stars = new();
