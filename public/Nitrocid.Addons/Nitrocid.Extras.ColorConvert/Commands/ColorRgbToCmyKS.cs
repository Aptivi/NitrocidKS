...
{
    /// <summary>
    /// Converts the color RGB numbers to CMY in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the CMY color numbers from the RGB representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorRgbToCmyKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string rgb = KernelColorConversionTools.ConvertFromRgbToCmy(R, G, B);
