...
{
    /// <summary>
    /// Converts the color YUV numbers to HSL in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the HSL color numbers from the YUV representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorYuvToHslKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yuv = KernelColorConversionTools.ConvertFromYuvToHsl(Y, U, V);
