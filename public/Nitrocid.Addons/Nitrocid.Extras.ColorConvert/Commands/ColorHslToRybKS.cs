...
{
    /// <summary>
    /// Converts the color HSL numbers to RYB in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorHslToRybKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string ryb = KernelColorConversionTools.ConvertFromHslToRyb(H, S, L);
