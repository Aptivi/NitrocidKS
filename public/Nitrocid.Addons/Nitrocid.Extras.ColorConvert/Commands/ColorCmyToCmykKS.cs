...
{
    /// <summary>
    /// Converts the color CMY numbers to CMYK in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the CMYK color numbers from the CMY representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorCmyToCmykKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            var CMYK = KernelColorConversionTools.ConvertFromCmyToCmyk(C, M, Y);
            TextWriters.Write("- " + Translate.DoTranslation("CMYK color sequence:") + " ", false, KernelColorType.ListEntry);
            TextWriters.Write($"{CMYK}", true, KernelColorType.ListValue);
            variableValue = CMYK;
            return 0;
        }
