...
{
    /// <summary>
    /// Converts the color HSL numbers to YIQ in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorHslToYiqKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yiq = KernelColorConversionTools.ConvertFromHslToYiq(H, S, L);
