...
{
    /// <summary>
    /// Converts the color YIQ numbers to HSV in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the HSV color numbers from the YIQ representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorYiqToHsvKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yiq = KernelColorConversionTools.ConvertFromYiqToHsv(Y, I, Q);
