...
{
    /// <summary>
    /// Converts the color YUV numbers to RGB in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorYuvToRgbKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string rgb = KernelColorConversionTools.ConvertFromYuvToRgb(Y, U, V);
