...
{
    /// <summary>
    /// Converts the color HSL numbers to HSV.
    /// </summary>
    /// <remarks>
    /// If you want to get the HSV representation of the color from the HSL color numbers, you can use this command.
    /// </remarks>
    class ColorHslToHsvCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            var hsl = new Color($"hsl:{H};{S};{L}");
            var hsv = HsvConversionTools.ConvertFrom(hsl.RGB);
