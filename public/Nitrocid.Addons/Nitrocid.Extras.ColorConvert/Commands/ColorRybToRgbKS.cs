...
{
    /// <summary>
    /// Converts the color RYB numbers to RGB in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorRybToRgbKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string rgb = KernelColorConversionTools.ConvertFromRybToRgb(R, Y, B);
