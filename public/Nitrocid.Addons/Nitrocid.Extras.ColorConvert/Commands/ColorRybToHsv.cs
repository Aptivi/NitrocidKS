...
{
    /// <summary>
    /// Converts the color RYB numbers to HSV.
    /// </summary>
    /// <remarks>
    /// If you want to get the HSV representation of the color from the RYB color numbers, you can use this command.
    /// </remarks>
    class ColorRybToHsvCommand : BaseCommand, ICommand
    {
