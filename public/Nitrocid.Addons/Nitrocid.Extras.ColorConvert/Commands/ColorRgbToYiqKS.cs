...
{
    /// <summary>
    /// Converts the color RGB numbers to YIQ in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorRgbToYiqKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yiq = KernelColorConversionTools.ConvertFromRgbToYiq(H, S, V);
