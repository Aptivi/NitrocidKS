...
{
    /// <summary>
    /// Converts the color YIQ numbers to CMY.
    /// </summary>
    /// <remarks>
    /// If you want to get the CMY representation of the color from the YIQ color numbers, you can use this command.
    /// </remarks>
    class ColorYiqToCmyCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            var cmy = CmyConversionTools.ConvertFrom(yiq.RGB);
