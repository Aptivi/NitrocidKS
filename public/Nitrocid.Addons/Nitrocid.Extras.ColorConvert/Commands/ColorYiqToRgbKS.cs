...
{
    /// <summary>
    /// Converts the color YIQ numbers to RGB in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorYiqToRgbKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string rgb = KernelColorConversionTools.ConvertFromYiqToRgb(Y, I, Q);
