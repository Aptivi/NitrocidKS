...
{
    /// <summary>
    /// Converts the color YUV numbers to YIQ in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the YIQ color numbers from the YUV representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorYuvToYiqKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yiq = KernelColorConversionTools.ConvertFromYuvToYiq(Y, U, V);
