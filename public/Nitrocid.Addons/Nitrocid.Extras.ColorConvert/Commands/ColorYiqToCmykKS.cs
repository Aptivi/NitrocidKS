...
{
    /// <summary>
    /// Converts the color YIQ numbers to CMYK in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the CMYK color numbers from the YIQ representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorYiqToCmykKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yiq = KernelColorConversionTools.ConvertFromYiqToCmyk(Y, I, Q);
