...
{
    /// <summary>
    /// Converts the color CMY numbers to RGB.
    /// </summary>
    /// <remarks>
    /// If you want to get the RGB representation of the color from the CMY color numbers, you can use this command.
    /// </remarks>
    class ColorCmyToRgbCommand : BaseCommand, ICommand
    {
