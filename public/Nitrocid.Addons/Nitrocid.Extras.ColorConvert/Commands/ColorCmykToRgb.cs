...
{
    /// <summary>
    /// Converts the color CMYK numbers to RGB.
    /// </summary>
    /// <remarks>
    /// If you want to get the RGB representation of the color from the CMYK color numbers, you can use this command.
    /// </remarks>
    class ColorCmykToRgbCommand : BaseCommand, ICommand
    {
