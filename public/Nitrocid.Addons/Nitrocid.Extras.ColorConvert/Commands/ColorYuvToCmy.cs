...
{
    /// <summary>
    /// Converts the color YUV numbers to CMY.
    /// </summary>
    /// <remarks>
    /// If you want to get the CMY representation of the color from the YUV color numbers, you can use this command.
    /// </remarks>
    class ColorYuvToCmyCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            var cmy = CmyConversionTools.ConvertFrom(yuv.RGB);
