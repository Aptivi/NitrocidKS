...
{
    /// <summary>
    /// Converts the color RGB numbers to RYB in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorRgbToRybKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string ryb = KernelColorConversionTools.ConvertFromRgbToRyb(H, S, V);
