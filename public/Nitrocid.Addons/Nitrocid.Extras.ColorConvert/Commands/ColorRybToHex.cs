...
{
    /// <summary>
    /// Converts the color RYB numbers to hex.
    /// </summary>
    /// <remarks>
    /// If you want to get the hexadecimal representation of the color from the RYB color numbers, you can use this command.
    /// </remarks>
    class ColorRybToHexCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string hex = KernelColorConversionTools.ConvertFromRybToHex(R, Y, B);
