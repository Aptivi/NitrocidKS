...
{
    /// <summary>
    /// Converts the color RGB numbers to YUV in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorRgbToYuvKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yuv = KernelColorConversionTools.ConvertFromRgbToYuv(H, S, V);
