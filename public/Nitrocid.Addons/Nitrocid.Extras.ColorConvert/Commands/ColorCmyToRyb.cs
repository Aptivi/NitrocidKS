...
{
    /// <summary>
    /// Converts the color CMY numbers to RYB.
    /// </summary>
    /// <remarks>
    /// If you want to get the RYB representation of the color from the CMY color numbers, you can use this command.
    /// </remarks>
    class ColorCmyToRybCommand : BaseCommand, ICommand
    {
