...
{
    /// <summary>
    /// Converts the color RYB numbers to YIQ in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the YIQ color numbers from the RYB representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorRybToYiqKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string ryb = KernelColorConversionTools.ConvertFromRybToYiq(R, Y, B);
