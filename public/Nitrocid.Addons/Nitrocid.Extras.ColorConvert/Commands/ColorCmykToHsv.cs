...
{
    /// <summary>
    /// Converts the color CMYK numbers to HSV.
    /// </summary>
    /// <remarks>
    /// If you want to get the HSV representation of the color from the CMYK color numbers, you can use this command.
    /// </remarks>
    class ColorCmykToHsvCommand : BaseCommand, ICommand
    {
