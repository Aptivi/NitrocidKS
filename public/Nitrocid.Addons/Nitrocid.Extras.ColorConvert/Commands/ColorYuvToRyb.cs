...
{
    /// <summary>
    /// Converts the color YUV numbers to RYB.
    /// </summary>
    /// <remarks>
    /// If you want to get the RYB representation of the color from the YUV color numbers, you can use this command.
    /// </remarks>
    class ColorYuvToRybCommand : BaseCommand, ICommand
    {
