...
{
    /// <summary>
    /// Converts the color CMYK numbers to YIQ.
    /// </summary>
    /// <remarks>
    /// If you want to get the YIQ representation of the color from the CMYK color numbers, you can use this command.
    /// </remarks>
    class ColorCmykToYiqCommand : BaseCommand, ICommand
    {
