...
{
    /// <summary>
    /// Converts the color RYB numbers to CMYK.
    /// </summary>
    /// <remarks>
    /// If you want to get the CMYK representation of the color from the RYB color numbers, you can use this command.
    /// </remarks>
    class ColorRybToCmykCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            var cmyk = CmykConversionTools.ConvertFrom(ryb.RGB);
            var cmy = cmyk.CMY;
