...
{
    /// <summary>
    /// Converts the color CMYK numbers to CMY in KS format.
    /// </summary>
    /// <remarks>
    /// If you want to get the semicolon-delimited sequence of the CMY color numbers from the CMYK representation of the color, you can use this command. You can use this to form a valid color sequence to generate new color instances for your mods.
    /// </remarks>
    class ColorCmykToCmyKSCommand : BaseCommand, ICommand
    {
