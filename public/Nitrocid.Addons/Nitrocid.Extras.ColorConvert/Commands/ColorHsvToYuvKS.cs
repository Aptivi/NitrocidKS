...
{
    /// <summary>
    /// Converts the color HSV numbers to YUV in KS format.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    class ColorHsvToYuvKSCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            // Do the job
            string yuv = KernelColorConversionTools.ConvertFromHsvToYuv(H, S, V);
