    ...
    public static class PresentationTools
    {
        ...
        public static void Present(Presentation presentation, bool kiosk)
        {
            ...
            for (int i = 0; i < pages.Count; i++)
            {
                ...
                TextWriterWhereColor.WriteWhere($"[{i + 1}/{pages.Count}] - {page.Name}".Truncate(PresentationLowerInnerBorderLeft + 1), PresentationUpperBorderLeft, PresentationInformationalTop);
