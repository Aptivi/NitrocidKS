...
namespace KS.Misc.Screensaver.Displays
{
    ...
    internal class LinotypoDisplay : BaseScreensaver, IScreensaver
    {
        ...
        public override void ScreensaverLogic()
        {
            ...
            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Maximum characters: {0} (satisfying {1} columns)", MaxCharacters, LinotypoSettings.LinotypoTextColumns);
            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Width threshold: {0}", ColumnRowConsoleThreshold);
            ...
            if (Parsing.TryParsePath(LinotypoSettings.LinotypoWrite) && Checking.FileExists(LinotypoSettings.LinotypoWrite))
            {
                ...
                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Opening file {0} to write...", LinotypoSettings.LinotypoWrite);
            ...
            foreach (string Paragraph in LinotypeWrite.SplitNewLines())
            {
                ...
                if (CurrentColumn == 1)
                {
                    DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Column 1. Printing newline...");
                    ConsoleWrapper.WriteLine();
                }
                else
                {
                    DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Column {0}. Setting left to {1}...", CurrentColumn, CurrentColumnRowConsole);
                ...
                for (int IncompleteSentenceIndex = 0; IncompleteSentenceIndex <= IncompleteSentences.Count - 1; IncompleteSentenceIndex++)
                {
                    ...
                    for (int StruckCharIndex = 0; StruckCharIndex <= IncompleteSentence.Length - 1; StruckCharIndex++)
                    {
                        ...
                        {
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Line repeat in first line in new column. Indenting...");
                            if (CurrentColumn == 1)
                            {
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Column 1. Printing newline...");
                                ConsoleWrapper.WriteLine();
                        ...
                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Struck character: {0}", StruckChar);
                        ...
                        if (EtaoinMode)
                        {
                            ...
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Etaoin mode on. Delaying {0} ms...", WriteMs);

                            // Get the character
                            StruckChar = Convert.ToChar(LinotypeLayout[LinotypeColumnIndex, LinotypeKeyIndex]);
                            if (CappedEtaoin)
                            {
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Capped Etaoin.");
                                StruckChar = char.ToUpper(StruckChar);
                            }

                            // Advance the indexes of column and key, depending on their values, and get the character
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Etaoin type: {0}", LinotypoSettings.LinotypoEtaoinType);
                                ...
                                case LinotypoSettings.FillType.EtaoinPattern:
                                    {
                                        ...
                                        {
                                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Key index exceeded 7. Advancing to next column...");
                                            LinotypeKeyIndex = 0;
                                            LinotypeColumnIndex += 1;
                                        }
                                        if (LinotypeColumnIndex == LinotypeMaxColumnIndex + 1)
                                        {
                                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Column indexes exceeded. Resetting...");
                            ...
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Key index: {0} | Column index: {1}", LinotypeKeyIndex, LinotypeColumnIndex);
                        }
                        else
                        {
                            ...
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Probability: {0} Guarantee: {1}", Probability, LinotypoGuaranteed);
                            if (LinotypoGuaranteed)
                            {
                                // Sometimes, a typo is generated by missing a character.
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Made a typo!");
                                ...
                                if (MissGuaranteed)
                                {
                                    ...
                                    DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Missed a character!");
                                ...
                                else
                                {
                                    ...
                                    while (!StruckFound)
                                    {
                                        ...
                                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Strike chars index: {0}", StrikeCharsIndex1);
                                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Capped strike: {0}", CappedStrike);
                                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Strikes pattern: {0}", StrikesString);
                                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Found? {0}", StruckFound);
                                    }
                                    ...
                                    if (@"`-=\][';/.,".Contains(Convert.ToString(MistypedChar)) & CappedStrike)
                                    {
                                        ...
                                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Mistyped character is a symbol and the strike is capped.");
                                ...
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Capped Etaoin: {0}", CappedEtaoin);

                                // Trigger character counter mode
                                CountingCharacters = true;
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Counting...");
                            }
                        }
                        ...
                        {
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Counter increased. {0}", CharacterCounter);
                            CharacterCounter += 1;
                            if (CharacterCounter > LinotypoSettings.LinotypoEtaoinThreshold)
                            {
                                ...
                                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Etaoin mode on because threshold reached.");
                                EtaoinMode = true;
                        ...
                        {
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Etaoin mode off because end of sentence.");
                            StruckCharIndex = -1;
                            EtaoinMode = false;
                    ...
                    if (CountingCharacters)
                    {
                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Sentence ended before Etaoin mode is activated. Resetting counter...");
                        CountingCharacters = false;
                        CharacterCounter = 0;
        ...
        private void HandleNextColumn(ref int CurrentColumn, ref int CurrentColumnRowConsole, int ColumnRowConsoleThreshold)
        {
            if (LinotypoSettings.LinotypoTextColumns > 1)
            {
                if (ConsoleWrapper.CursorTop >= ConsoleWrapper.WindowHeight - 2)
                {
                    ...
                    {
                        // ...wait until retry
                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Drawn all columns. Waiting {0} ms...", LinotypoSettings.LinotypoNewScreenDelay);
                        ConsoleWrapper.WriteLine();
                    ...
                    else
                    {
                        ...
                        DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "New column. Moving to {0}...", CurrentColumnRowConsole);
                    }
                }
            }
            else if (LinotypoSettings.LinotypoTextColumns == 1 & ConsoleWrapper.CursorTop >= ConsoleWrapper.WindowHeight - 2)
            {
                ...
                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Drawn all text. Waiting {0} ms...", LinotypoSettings.LinotypoNewScreenDelay);
                ConsoleWrapper.WriteLine();
                ThreadManager.SleepNoBlock(LinotypoSettings.LinotypoNewScreenDelay, ScreensaverDisplayer.ScreensaverDisplayerThread);
