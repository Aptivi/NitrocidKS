    ...
    public static class ColorWheelOpen
    {
        ...
        public static string ColorWheel(bool TrueColor, ConsoleColors DefaultColor, int DefaultColorR, int DefaultColorG, int DefaultColorB)
        {
            ...
            while (!ColorWheelExiting)
            {
                ...
                if (TrueColor)
                {
                    TextWriterColor.Write(CharManager.NewLine + Translate.DoTranslation("Select color using \"<-\" and \"->\" keys. Press ENTER to quit. Press \"i\" to insert color number manually."), true, ColorTools.ColTypes.Tip);
                    ...
                    TextWriterColor.Write(CharManager.NewLine + "  ", false, ColorTools.ColTypes.NeutralText);
                    ...
                    TextWriterWhereColor.WriteWhere(WheelLeftFrameChar + " ".Repeat(ConsoleWrapper.WindowWidth - 6) + WheelRightFrameChar, 2, ConsoleWrapper.WindowHeight - 5, true, ColorTools.ColTypes.Gray);
                    TextWriterWhereColor.WriteWhere(WheelLeftFrameChar + " ".Repeat(ConsoleWrapper.WindowWidth - 6) + WheelRightFrameChar, 2, ConsoleWrapper.WindowHeight - 4, true, ColorTools.ColTypes.Gray);
                    TextWriterWhereColor.WriteWhere(WheelLeftFrameChar + " ".Repeat(ConsoleWrapper.WindowWidth - 6) + WheelRightFrameChar, 2, ConsoleWrapper.WindowHeight - 3, true, ColorTools.ColTypes.Gray);
                    TextWriterWhereColor.WriteWhere(WheelLowerLeftCornerChar + WheelLowerFrameChar.Repeat(ConsoleWrapper.WindowWidth - 6) + WheelLowerRightCornerChar, 2, ConsoleWrapper.WindowHeight - 2, true, ColorTools.ColTypes.Gray);
                ...
                {
                    TextWriterColor.Write(CharManager.NewLine + Translate.DoTranslation("Select color using \"<-\" and \"->\" keys. Use arrow up and arrow down keys to select between color ranges. Press ENTER to quit. Press \"i\" to insert color number manually."), true, ColorTools.ColTypes.Tip);
                    TextWriterColor.Write(Translate.DoTranslation("Press \"t\" to switch to true color mode."), true, ColorTools.ColTypes.Tip);

                    // The color selection
                    TextWriterColor.Write(CharManager.NewLine + "   < ", false, ColorTools.ColTypes.Gray);
