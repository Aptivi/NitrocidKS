...
namespace KS.Network
{
    ...
    public static class NetworkAdapterPrint
    {
        ...
        public static void PrintAdapterIPv6Info(NetworkInterface NInterface, IPv6InterfaceProperties Properties, long AdapterNumber)
        {
            if (Flags.ExtensiveAdapterInformation)
            {
                TextWriterColor.Write(Translate.DoTranslation("IPv6 information:") + CharManager.NewLine + Translate.DoTranslation("Adapter Number:") + " {0}" + CharManager.NewLine + Translate.DoTranslation("Adapter Name:") + " {1}" + CharManager.NewLine + Translate.DoTranslation("Maximum Transmission Unit: {2} Units"), AdapterNumber, NInterface.Description, Properties.Mtu);
            }
            else
            {
                TextWriterColor.Write(Translate.DoTranslation("IPv6 information:") + CharManager.NewLine + Translate.DoTranslation("Adapter Number:") + " {0}" + CharManager.NewLine + Translate.DoTranslation("Adapter Name:") + " {1}", AdapterNumber, NInterface.Description);
            }
        }
