...
{
    /// <summary>
    /// Thrown when event is nonexistent
    /// </summary>
    public class NoSuchEventException : Exception
    {
        ...
        public NoSuchEventException(string message, params object[] vars) : base(StringManipulate.FormatString(message, vars))
        {
        }
        /// <inheritdoc/>
        public NoSuchEventException(string message, Exception e) : base(message, e)
        {
        }
        /// <summary>
        ...
        /// <param name="message">Message to be printed</param>
        public NoSuchEventException(string message, Exception e, params object[] vars) : base(StringManipulate.FormatString(message, vars), e)
        {
        }
