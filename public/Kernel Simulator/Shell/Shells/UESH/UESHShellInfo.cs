...
namespace KS.Shell.Shells.UESH
{
    ...
    internal class UESHShellInfo : BaseShellInfo, IShellInfo
    {
        ...
        public override Dictionary<string, CommandInfo> Commands => new()
        {
            ...
            { "bulkrename", new CommandInfo("bulkrename", ShellType.Shell, "Renames group of files to selected format", new CommandArgumentInfo(new[] { "<targetdir> <pattern> <newname>" }, true, 2), new BulkRenameCommand()) },
            ...
            { "perm", new CommandInfo("perm", ShellType.Shell, "Manage permissions for users", new CommandArgumentInfo(new[] { "<userName> <allow/revoke> <perm>" }, true, 3, (_) => UserManagement.ListAllUsers().Where((src) => src.StartsWith(_)).ToArray()), new PermCommand(), CommandFlags.Strict) },
            ...
            { "playlyric", new CommandInfo("playlyric", ShellType.Shell, "Plays a lyric file", new CommandArgumentInfo(new[] { "<lyric.lrc>" }, true, 1), new PlayLyricCommand()) },
