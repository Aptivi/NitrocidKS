...
namespace KS.Shell.Shells.UESH
{
    ...
    internal class UESHShellInfo : BaseShellInfo, IShellInfo
    {
        ...
        public override Dictionary<string, CommandInfo> Commands => new()
        {
            ...
            { "chlang", new CommandInfo("chlang", ShellType.Shell, "Changes language", new CommandArgumentInfo(new[] { "[-alwaystransliterated|-alwaystranslated|-force] <language>" }, true, 1, (_) => Languages.LanguageManager.Languages.Keys.Where((src) => src.StartsWith(_)).ToArray()), new ChLangCommand(), CommandFlags.Strict | CommandFlags.Obsolete) },
