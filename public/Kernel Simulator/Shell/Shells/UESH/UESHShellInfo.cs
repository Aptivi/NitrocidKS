...
namespace KS.Shell.Shells.UESH
{
    ...
    internal class UESHShellInfo : BaseShellInfo, IShellInfo
    {
        ...
        public override Dictionary<string, CommandInfo> Commands => new()
        {
            ...
            { "retroks", new CommandInfo("retroks", ShellType, /* Localizable */ "Retro Kernel Simulator based on 0.0.4.1", new CommandArgumentInfo(), new RetroKSCommand()) },
            ...
            { "rss", new CommandInfo("rss", ShellType, /* Localizable */ "Opens an RSS shell to read the feeds", new CommandArgumentInfo(new[] { "[feedlink]" }, false, 0), new RssCommand()) },
            ...
            { "setsaver", new CommandInfo("setsaver", ShellType, /* Localizable */ "Sets up kernel screensavers", new CommandArgumentInfo(new[] { "<customsaver/builtinsaver>" }, true, 1), new SetSaverCommand(), CommandFlags.Strict | CommandFlags.Obsolete) },
