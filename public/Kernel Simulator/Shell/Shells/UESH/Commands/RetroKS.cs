...
namespace KS.Shell.Shells.UESH.Commands
{
    ...
    class RetroKSCommand : CommandExecutor, ICommand
    {
        ...
        public override void Execute(string StringArgs, string[] ListArgsOnly, string[] ListSwitchesOnly)
        {
            ...
            {
                TextWriterColor.Write(Translate.DoTranslation("Downloading version") + " {0}...", true, ColorTools.ColTypes.Neutral, SortedVersions[0].UpdateVersion.ToString());
                ...
                // Extract it
                TextWriterColor.Write(Translate.DoTranslation("Installing version") + " {0}...", true, ColorTools.ColTypes.Neutral, SortedVersions[0].UpdateVersion.ToString());
            ...
            TextWriterColor.Write(Translate.DoTranslation("Going back to 2018..."), true, ColorTools.ColTypes.Neutral);
