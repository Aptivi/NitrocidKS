...
namespace KS.Shell.Shells.UESH.Commands
{
    ...
    class ChoiceCommand : CommandExecutor, ICommand
    {
        ...
        {
            TextWriterColor.Write(Translate.DoTranslation("where <$variable> is any variable that will be used to store response") + CharManager.NewLine + Translate.DoTranslation("where <answers> are one-lettered answers of the question separated in slashes"), true, ColorTools.ColTypes.NeutralText);
