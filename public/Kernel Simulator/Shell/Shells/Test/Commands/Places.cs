...
namespace KS.Shell.Shells.Test.Commands
{
    ...
    class Test_PlacesCommand : CommandExecutor, ICommand
    {
        ...
        public override void Execute(string StringArgs, string[] ListArgsOnly, string[] ListSwitchesOnly) => TextWriterColor.Write(PlaceParse.ProbePlaces(ListArgsOnly[0]), true, ColorTools.ColTypes.Neutral);
