...
namespace KS.Shell.Shells.RSS.Commands
{
    ...
    /// <br></br>
    /// </remarks>
    class RSS_SearchCommand : CommandExecutor, ICommand
    {
        ...
        public override void Execute(string StringArgs, string[] ListArgsOnly, string[] ListSwitchesOnly)
        {
            ...
            foreach (RSSArticle Article in foundArticles)
            {
                ...
                TextWriterColor.Write("    {0}", true, ColorTools.ColTypes.NeutralText, Article.ArticleDescription.SplitNewLines()[0].Truncate(200));
            }
        }
