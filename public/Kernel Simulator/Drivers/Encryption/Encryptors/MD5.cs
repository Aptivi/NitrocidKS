...
namespace KS.Drivers.Encryption.Encryptors
{
    ...
    public class MD5 : IEncryptor
    {
        ...
        /// <inheritdoc/>
        public bool VerifyHashFromHash(string FileName, string ExpectedHash, string ActualHash) => HashVerifier.VerifyHashFromHash(FileName, EncryptionAlgorithms.MD5, ExpectedHash, ActualHash);

        /// <inheritdoc/>
        public bool VerifyHashFromHashesFile(string FileName, string HashesFile, string ActualHash) => HashVerifier.VerifyHashFromHashesFile(FileName, EncryptionAlgorithms.MD5, HashesFile, ActualHash);

        /// <inheritdoc/>
        public bool VerifyUncalculatedHashFromHash(string FileName, string ExpectedHash) => HashVerifier.VerifyUncalculatedHashFromHash(FileName, EncryptionAlgorithms.MD5, ExpectedHash);

        /// <inheritdoc/>
        public bool VerifyUncalculatedHashFromHashesFile(string FileName, string HashesFile) => HashVerifier.VerifyUncalculatedHashFromHashesFile(FileName, EncryptionAlgorithms.MD5, HashesFile);
    }
}
