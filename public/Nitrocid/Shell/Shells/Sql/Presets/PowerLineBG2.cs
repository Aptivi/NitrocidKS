...
namespace KS.Shell.Shells.Sql.Presets
{
    /// <summary>
    ...
    public class SqlPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            {
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), SqlShellCommon.Sql_DatabaseFileName, default, TransitionPartChar)
            };
