    ...
    public class PowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            List<PowerLineSegment> segments = new()
            {
                ...
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), $"{CurrentDirectory.CurrentDir} [{ShellManager.ShellStack.Count}]", default, TransitionPartChar),
            };
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments = new()
            {
                ...
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), "/home/user [1]", default, TransitionPartChar),
            };
