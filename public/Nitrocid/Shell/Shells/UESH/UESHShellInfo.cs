    ...
    internal class UESHShellInfo : BaseShellInfo, IShellInfo
    {
        ...
        public override Dictionary<string, CommandInfo> Commands => new()
        {
            ...
            { "cat", new CommandInfo("cat", ShellType, /* Localizable */ "Prints content of file to console",
                new CommandArgumentInfo(new[] { "file" }, new[] { new SwitchInfo("lines", /* Localizable */ "Prints the line numbers alongside the contents"), new SwitchInfo("nolines", /* Localizable */ "Prints only the contents"), new SwitchInfo("plain", /* Localizable */ "Force treating binary files as plain text") }, true, 1), new CatCommand(), CommandFlags.RedirectionSupported | CommandFlags.Wrappable) },
            ...
            { "choice", new CommandInfo("choice", ShellType, /* Localizable */ "Makes user choices",
                new CommandArgumentInfo(new[] { "$variable", "answers", "input", "answertitle1", "answertitle2 ..." }, new[] { new SwitchInfo("o", /* Localizable */ "One line choice style"), new SwitchInfo("t", /* Localizable */ "Two lines choice style"), new SwitchInfo("m", /* Localizable */ "Modern choice style"), new SwitchInfo("a", /* Localizable */ "Table choice style"), new SwitchInfo("single", /* Localizable */ "The output can be only one character"), new SwitchInfo("multiple", /* Localizable */ "The output can be more than a character") }, true, 3), new ChoiceCommand(), CommandFlags.SettingVariable) },
            ...
            { "convertlineendings", new CommandInfo("convertlineendings", ShellType, /* Localizable */ "Converts the line endings to format for the current platform or to specified custom format",
                new CommandArgumentInfo(new[] { "textfile" }, new[] { new SwitchInfo("w", /* Localizable */ "Converts the line endings to the Windows format"), new SwitchInfo("u", /* Localizable */ "Converts the line endings to the Unix format"), new SwitchInfo("m", /* Localizable */ "Converts the line endings to the Mac OS 9 format") }, true, 1), new ConvertLineEndingsCommand()) },
            ...
            { "edit", new CommandInfo("edit", ShellType, /* Localizable */ "Edits a file",
                new CommandArgumentInfo(new[] { "file" }, new SwitchInfo[] { new SwitchInfo("text", /* Localizable */ "Forces text mode", false, false, new string[] { "hex", "json" }), new SwitchInfo("hex", /* Localizable */ "Forces hex mode", false, false, new string[] { "text", "json" }), new SwitchInfo("json", /* Localizable */ "Forces JSON mode", false, false, new string[] { "text", "hex" }) }, true, 1), new EditCommand()) },
            ...
            { "settings", new CommandInfo("settings", ShellType, /* Localizable */ "Changes kernel configuration",
                new CommandArgumentInfo(Array.Empty<string>(), new[] { new SwitchInfo("saver", /* Localizable */ "Opens the screensaver settings"), new SwitchInfo("splash", /* Localizable */ "Opens the splash settings") }, false, 0), new SettingsCommand(), CommandFlags.Strict) },
            ...
            { "speedpress", new CommandInfo("speedpress", ShellType, /* Localizable */ "See if you can press a key on time",
                new CommandArgumentInfo(Array.Empty<string>(), new[] { new SwitchInfo("e", /* Localizable */ "Starts the game in easy difficulty"), new SwitchInfo("m", /* Localizable */ "Starts the game in medium difficulty"), new SwitchInfo("h", /* Localizable */ "Starts the game in hard difficulty"), new SwitchInfo("v", /* Localizable */ "Starts the game in very hard difficulty"), new SwitchInfo("c", /* Localizable */ "Starts the game in custom difficulty. Please note that the custom timeout in milliseconds should be written as argument.", false, true), }, false, 0), new SpeedPressCommand()) },
            ...
            { "zip", new CommandInfo("zip", ShellType, /* Localizable */ "Creates a ZIP archive",
                new CommandArgumentInfo(new[] { "zipfile", "path" }, new[] { new SwitchInfo("fast", /* Localizable */ "Fast compression"), new SwitchInfo("nocomp", /* Localizable */ "No compression"), new SwitchInfo("nobasedir", /* Localizable */ "Don't create base directory in archive") }, true, 2), new ZipCommand()) },
