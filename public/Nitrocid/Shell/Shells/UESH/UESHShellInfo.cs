...
namespace KS.Shell.Shells.UESH
{
    ...
    internal class UESHShellInfo : BaseShellInfo, IShellInfo
    {
        ...
        public override Dictionary<string, CommandInfo> Commands => new()
        {
            ...
            { "contacts", new CommandInfo("contacts", ShellType, /* Localizable */ "Manages your contacts", new CommandArgumentInfo(new[] { "<list>", "<add> <path/to/contact.vcf>", "<remove> <contactId>" }, true, 1), new ContactsCommand()) },
