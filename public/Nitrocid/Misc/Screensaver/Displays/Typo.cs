    ...
    public class TypoDisplay : BaseScreensaver, IScreensaver
    {
        ...
        public override void ScreensaverLogic()
        {
            ...
            foreach (char StruckChar in TypoSettings.TypoWrite)
            {
                ...
                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Struck character: {0}", StruckCharAssigned);
                ...
                DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Probability: {0} Guarantee: {1}", Probability, TypoGuaranteed);
                if (TypoGuaranteed)
                {
                    ...
                    else
                    {
                        ...
                        while (!StruckFound)
                        {
                            ...
                            DebugWriter.WriteDebugConditional(Screensaver.ScreensaverDebug, DebugLevel.I, "Strike chars index: {0}", StrikeCharsIndex);
