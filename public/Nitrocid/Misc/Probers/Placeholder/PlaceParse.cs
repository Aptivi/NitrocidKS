...
namespace KS.Misc.Probers.Placeholder
{
    ...
    public static class PlaceParse
    {
        private readonly static Dictionary<string, Func<string>> placeholders = new()
        {
            ...
            { "<shortdate>",                        () => TimeDateRenderers.RenderDate(TimeDate.TimeDate.FormatType.Short) },
            { "<longdate>",                         () => TimeDateRenderers.RenderDate(TimeDate.TimeDate.FormatType.Long) },
            { "<shorttime>",                        () => TimeDateRenderers.RenderTime(TimeDate.TimeDate.FormatType.Short) },
            { "<longtime>",                         () => TimeDateRenderers.RenderTime(TimeDate.TimeDate.FormatType.Long) },
