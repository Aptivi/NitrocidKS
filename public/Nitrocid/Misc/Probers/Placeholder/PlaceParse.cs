...
namespace KS.Misc.Probers.Placeholder
{
    ...
    public static class PlaceParse
    {
        private readonly static Dictionary<string, Func<string>> placeholders = new()
        {
            ...
            { "<shortdate>",                        () => TimeDateRenderers.RenderDate(TimeDate.TimeDateTools.FormatType.Short) },
            { "<longdate>",                         () => TimeDateRenderers.RenderDate(TimeDate.TimeDateTools.FormatType.Long) },
            { "<shorttime>",                        () => TimeDateRenderers.RenderTime(TimeDate.TimeDateTools.FormatType.Short) },
            { "<longtime>",                         () => TimeDateRenderers.RenderTime(TimeDate.TimeDateTools.FormatType.Long) },
