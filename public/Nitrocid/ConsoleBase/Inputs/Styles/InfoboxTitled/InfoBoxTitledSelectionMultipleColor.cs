...
namespace KS.ConsoleBase.Inputs.Styles.InfoboxTitled
{
    ...
    public static class InfoBoxTitledSelectionMultipleColor
    {
        ...
        public static int[] WriteInfoBoxTitledSelectionMultiple(string title, InputChoiceInfo[] selections, string text, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
        ...
        /// <param name="title">Title to be written</param>
        /// <param name="selections">List of choices</param>
        /// <param name="InfoBoxTitledSelectionMultipleColor">InfoBoxTitledSelectionMultiple color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="text">Text to be written.</param>
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>List of selected choice index (starting from zero), or an empty array if exited, selection list is empty, or an error occurred</returns>
        public static int[] WriteInfoBoxTitledSelectionMultipleKernelColor(string title, InputChoiceInfo[] selections, string text, KernelColorType InfoBoxTitledSelectionMultipleColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        InfoBoxTitledSelectionMultipleColor, KernelColorType.Background, vars);
        ...
        /// <param name="selections">List of choices</param>
        /// <param name="InfoBoxTitledSelectionMultipleColor">InfoBoxTitledSelectionMultiple color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="BackgroundColor">InfoBoxTitledSelectionMultiple background color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="text">Text to be written.</param>
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>List of selected choice index (starting from zero), or an empty array if exited, selection list is empty, or an error occurred</returns>
        public static int[] WriteInfoBoxTitledSelectionMultipleKernelColor(string title, InputChoiceInfo[] selections, string text, KernelColorType InfoBoxTitledSelectionMultipleColor, KernelColorType BackgroundColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColor(string title, InputChoiceInfo[] selections, string text, ConsoleColors InfoBoxTitledSelectionMultipleColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleColorBack(title, selections, text,
                        ...
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        new Color(InfoBoxTitledSelectionMultipleColor), KernelColorTools.GetColor(KernelColorType.Background), vars);
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColor(string title, InputChoiceInfo[] selections, string text, Color InfoBoxTitledSelectionMultipleColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleColorBack(title, selections, text,
                        ...
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        InfoBoxTitledSelectionMultipleColor, KernelColorTools.GetColor(KernelColorType.Background), vars);
        ...
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>List of selected choice index (starting from zero), or an empty array if exited, selection list is empty, or an error occurred</returns>
        public static int[] WriteInfoBoxTitledSelectionMultipleKernelColor(string title, InputChoiceInfo[] selections, string text,
                                       char UpperLeftCornerChar, char LowerLeftCornerChar, char UpperRightCornerChar, char LowerRightCornerChar,
                                       char UpperFrameChar, char LowerFrameChar, char LeftFrameChar, char RightFrameChar,
                                       KernelColorType InfoBoxTitledSelectionMultipleColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleKernelColor(title, selections, text,
                UpperLeftCornerChar, LowerLeftCornerChar,
                UpperRightCornerChar, LowerRightCornerChar,
                UpperFrameChar, LowerFrameChar,
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleKernelColor(string title, InputChoiceInfo[] selections, string text,
                                       char UpperLeftCornerChar, char LowerLeftCornerChar, char UpperRightCornerChar, char LowerRightCornerChar,
                                       char UpperFrameChar, char LowerFrameChar, char LeftFrameChar, char RightFrameChar,
                                       KernelColorType InfoBoxTitledSelectionMultipleColor, KernelColorType BackgroundColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleColorBack(
                ...
                KernelColorTools.GetColor(InfoBoxTitledSelectionMultipleColor), KernelColorTools.GetColor(BackgroundColor), vars);
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColor(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionMultipleColorBack(title, selections, text, UpperLeftCornerChar, LowerLeftCornerChar, UpperRightCornerChar, LowerRightCornerChar, UpperFrameChar, LowerFrameChar, LeftFrameChar, RightFrameChar, new Color(InfoBoxTitledSelectionMultipleColor), KernelColorTools.GetColor(KernelColorType.Background), vars);
