...
namespace KS.ConsoleBase.Inputs.Styles.InfoboxTitled
{
    ...
    public static class InfoBoxTitledSelectionColor
    {
        ...
        public static int WriteInfoBoxTitledSelection(string title, InputChoiceInfo[] selections, string text, params object[] vars) =>
            WriteInfoBoxTitledSelectionKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
        ...
        /// <param name="title">Title to be written</param>
        /// <param name="selections">List of choices</param>
        /// <param name="InfoBoxTitledSelectionColor">InfoBoxTitledSelection color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="text">Text to be written.</param>
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>Selected choice index (starting from zero), or -1 if exited, selection list is empty, or an error occurred</returns>
        public static int WriteInfoBoxTitledSelectionKernelColor(string title, InputChoiceInfo[] selections, string text, KernelColorType InfoBoxTitledSelectionColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        InfoBoxTitledSelectionColor, KernelColorType.Background, vars);
        ...
        /// <param name="selections">List of choices</param>
        /// <param name="InfoBoxTitledSelectionColor">InfoBoxTitledSelection color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="BackgroundColor">InfoBoxTitledSelection background color from Nitrocid KS's <see cref="KernelColorType"/></param>
        /// <param name="text">Text to be written.</param>
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>Selected choice index (starting from zero), or -1 if exited, selection list is empty, or an error occurred</returns>
        public static int WriteInfoBoxTitledSelectionKernelColor(string title, InputChoiceInfo[] selections, string text, KernelColorType InfoBoxTitledSelectionColor, KernelColorType BackgroundColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionKernelColor(title, selections, text,
                        BorderTools.BorderUpperLeftCornerChar, BorderTools.BorderLowerLeftCornerChar,
                        BorderTools.BorderUpperRightCornerChar, BorderTools.BorderLowerRightCornerChar,
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
        ...
        public static int WriteInfoBoxTitledSelectionColor(string title, InputChoiceInfo[] selections, string text, ConsoleColors InfoBoxTitledSelectionColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionColorBack(title, selections, text,
                        ...
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        new Color(InfoBoxTitledSelectionColor), KernelColorTools.GetColor(KernelColorType.Background), vars);
        ...
        public static int WriteInfoBoxTitledSelectionColor(string title, InputChoiceInfo[] selections, string text, Color InfoBoxTitledSelectionColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionColorBack(title, selections, text,
                        ...
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        InfoBoxTitledSelectionColor, KernelColorTools.GetColor(KernelColorType.Background), vars);
        ...
        /// <param name="vars">Variables to format the message before it's written.</param>
        /// <returns>Selected choice index (starting from zero), or -1 if exited, selection list is empty, or an error occurred</returns>
        public static int WriteInfoBoxTitledSelectionKernelColor(string title, InputChoiceInfo[] selections, string text,
                                       char UpperLeftCornerChar, char LowerLeftCornerChar, char UpperRightCornerChar, char LowerRightCornerChar,
                                       char UpperFrameChar, char LowerFrameChar, char LeftFrameChar, char RightFrameChar,
                                       KernelColorType InfoBoxTitledSelectionColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionKernelColor(title, selections, text,
                UpperLeftCornerChar, LowerLeftCornerChar,
                UpperRightCornerChar, LowerRightCornerChar,
                UpperFrameChar, LowerFrameChar,
        ...
        public static int WriteInfoBoxTitledSelectionKernelColor(string title, InputChoiceInfo[] selections, string text,
                                       char UpperLeftCornerChar, char LowerLeftCornerChar, char UpperRightCornerChar, char LowerRightCornerChar,
                                       char UpperFrameChar, char LowerFrameChar, char LeftFrameChar, char RightFrameChar,
                                       KernelColorType InfoBoxTitledSelectionColor, KernelColorType BackgroundColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionColorBack(
                ...
                KernelColorTools.GetColor(InfoBoxTitledSelectionColor), KernelColorTools.GetColor(BackgroundColor), vars);
        ...
        public static int WriteInfoBoxTitledSelectionColor(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionColorBack(title, selections, text, UpperLeftCornerChar, LowerLeftCornerChar, UpperRightCornerChar, LowerRightCornerChar, UpperFrameChar, LowerFrameChar, LeftFrameChar, RightFrameChar, new Color(InfoBoxTitledSelectionColor), KernelColorTools.GetColor(KernelColorType.Background), vars);
