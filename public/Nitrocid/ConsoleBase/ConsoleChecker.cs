...
namespace KS.ConsoleBase
{
    ...
    public static class ConsoleChecker
    {
        ...
        public static void CheckConsole()
        {
            ...
            // ---
            // More information regarding this check: The blacklisted terminals will not be able to run Nitrocid KS properly, because they have
            ...
            if (KernelPlatform.IsOnMacOS())
            {
                if (TerminalEmulator == "Apple_Terminal")
                {
                    throw new KernelException(
                        ...
                        "Nitrocid KS makes use of VT escape sequences, but Terminal.app has broken support for 255 and true colors." + CharManager.NewLine +
            ...
            // still use the VT sequence to print colored text.
        ...
        internal static void CheckConsoleSize()
        {
            ...
            {
                TextWriterColor.WriteKernelColor(Translate.DoTranslation("Your console is too small to run properly:") + " {0}x{1} | buff: {2}x{3}", true, KernelColorType.Warning, ConsoleWrapper.WindowWidth, ConsoleWrapper.WindowHeight, ConsoleWrapper.BufferWidth, ConsoleWrapper.BufferHeight);
