...
<TestClass()> Public Class EncryptionActionTests
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestGetEncryptedFileUsingStream()
        Dim FileStreamHash As FileStream = File.Create(GetOtherPath(OtherPathType.Home) + "/TestSum.txt")
        ...
        File.Delete(GetOtherPath(OtherPathType.Home) + "/TestSum.txt")
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestGetEncryptedFileUsingPath()
        ...
        FileStreamHash.Flush()
        FileStreamHash.Close()
        Dim FileHashMD5 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.MD5)
        Dim FileHashSHA1 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA1)
        Dim FileHashSHA256 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA256)
        Dim FileHashSHA384 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA384)
        Dim FileHashSHA512 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA512)
        File.Delete(GetOtherPath(OtherPathType.Home) + "/TestSum.txt")
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestVerifyHashFromHash()
        ...
        Dim FileHashSHA512 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA512)
        Try
            Dim ResultMD5 As Boolean = VerifyHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.MD5, "CD5578C85A4CF32E48D157746A90C7F6", FileHashMD5)
            Dim ResultSHA1 As Boolean = VerifyHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA1, "36EBF31AF7234D6C99CA65DC4EDA524161600657", FileHashSHA1)
            Dim ResultSHA256 As Boolean = VerifyHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA256, "7E6857729A34755DE8C2C9E535A8765BDE241F593BE3588B8FA6D29D949EFADA", FileHashSHA256)
            Dim ResultSHA384 As Boolean = VerifyHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA384, "92CBCB3F982C7EC24EED668175D4FE7C73D9BBCBECA659EDDE6D6E56B798D64C808F86C7E13FA6BE03464AE2D145BB60", FileHashSHA384)
            Dim ResultSHA512 As Boolean = VerifyHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA512, "6DF635C184D4B131B0243D4F2BD66925A61B82A5093F573920F42D7B8474D6332FD2886920F3CA36D9206C73DD59C8F1EEA18501E6FEF15FDDA664B1ABB0E361", FileHashSHA512)
            File.Delete(GetOtherPath(OtherPathType.Home) + "/TestSum.txt")
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestVerifyUncalculatedHashFromHash()
        ...
        Dim FileHashSHA512 As String = GetEncryptedFile(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA512)
        Try
            Dim ResultMD5 As Boolean = VerifyUncalculatedHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.MD5, "CD5578C85A4CF32E48D157746A90C7F6")
            Dim ResultSHA1 As Boolean = VerifyUncalculatedHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA1, "36EBF31AF7234D6C99CA65DC4EDA524161600657")
            Dim ResultSHA256 As Boolean = VerifyUncalculatedHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA256, "7E6857729A34755DE8C2C9E535A8765BDE241F593BE3588B8FA6D29D949EFADA")
            Dim ResultSHA384 As Boolean = VerifyUncalculatedHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA384, "92CBCB3F982C7EC24EED668175D4FE7C73D9BBCBECA659EDDE6D6E56B798D64C808F86C7E13FA6BE03464AE2D145BB60")
            Dim ResultSHA512 As Boolean = VerifyUncalculatedHashFromHash(GetOtherPath(OtherPathType.Home) + "/TestSum.txt", Algorithms.SHA512, "6DF635C184D4B131B0243D4F2BD66925A61B82A5093F573920F42D7B8474D6332FD2886920F3CA36D9206C73DD59C8F1EEA18501E6FEF15FDDA664B1ABB0E361")
            File.Delete(GetOtherPath(OtherPathType.Home) + "/TestSum.txt")
            ResultMD5.ShouldBeTrue
            ResultSHA1.ShouldBeTrue
            ResultSHA256.ShouldBeTrue
    ...
    <TestMethod> <TestCategory("Action")> Public Sub TestGetEmptyHash()
        ...
        GetEmptyHash(Algorithms.SHA384).ShouldNotBeNullOrEmpty
