...
<TestClass()> Public Class EncryptionActionTests
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestGetEncryptedFileUsingPath()
        ...
        Dim FileHashSHA384 As String = GetEncryptedFile(paths("Home") + "/TestSum.txt", Algorithms.SHA384)
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestVerifyHashFromHash()
        ...
        Try
            ...
            Dim ResultSHA384 As Boolean = VerifyHashFromHash(paths("Home") + "/TestSum.txt", Algorithms.SHA384, "92CBCB3F982C7EC24EED668175D4FE7C73D9BBCBECA659EDDE6D6E56B798D64C808F86C7E13FA6BE03464AE2D145BB60", FileHashSHA384)
    ...
    <TestMethod()> <TestCategory("Action")> Public Sub TestVerifyUncalculatedHashFromHash()
        ...
        Try
            ...
            Dim ResultSHA384 As Boolean = VerifyUncalculatedHashFromHash(paths("Home") + "/TestSum.txt", Algorithms.SHA384, "92CBCB3F982C7EC24EED668175D4FE7C73D9BBCBECA659EDDE6D6E56B798D64C808F86C7E13FA6BE03464AE2D145BB60")
