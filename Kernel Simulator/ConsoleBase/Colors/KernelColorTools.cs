...
namespace KS.ConsoleBase.Colors
{
    public static class KernelColorTools
    {
        ...
        {
            Config.ConfigToken["Colors"]["User Name Shell Color"] = UserNameShellColor.PlainSequence;
            Config.ConfigToken["Colors"]["Host Name Shell Color"] = HostNameShellColor.PlainSequence;
            Config.ConfigToken["Colors"]["Continuable Kernel Error Color"] = ContKernelErrorColor.PlainSequence;
            Config.ConfigToken["Colors"]["Uncontinuable Kernel Error Color"] = UncontKernelErrorColor.PlainSequence;
            Config.ConfigToken["Colors"]["Text Color"] = NeutralTextColor.PlainSequence;
            Config.ConfigToken["Colors"]["License Color"] = LicenseColor.PlainSequence;
            Config.ConfigToken["Colors"]["Background Color"] = BackgroundColor.PlainSequence;
            Config.ConfigToken["Colors"]["Input Color"] = InputColor.PlainSequence;
            Config.ConfigToken["Colors"]["List Entry Color"] = ListEntryColor.PlainSequence;
            Config.ConfigToken["Colors"]["List Value Color"] = ListValueColor.PlainSequence;
            Config.ConfigToken["Colors"]["Kernel Stage Color"] = StageColor.PlainSequence;
            Config.ConfigToken["Colors"]["Error Text Color"] = ErrorColor.PlainSequence;
            Config.ConfigToken["Colors"]["Warning Text Color"] = WarningColor.PlainSequence;
            Config.ConfigToken["Colors"]["Option Color"] = OptionColor.PlainSequence;
            Config.ConfigToken["Colors"]["Banner Color"] = BannerColor.PlainSequence;
            Config.ConfigToken["Colors"]["Notification Title Color"] = NotificationTitleColor.PlainSequence;
            Config.ConfigToken["Colors"]["Notification Description Color"] = NotificationDescriptionColor.PlainSequence;
            Config.ConfigToken["Colors"]["Notification Progress Color"] = NotificationProgressColor.PlainSequence;
            Config.ConfigToken["Colors"]["Notification Failure Color"] = NotificationFailureColor.PlainSequence;
            Config.ConfigToken["Colors"]["Question Color"] = QuestionColor.PlainSequence;
            Config.ConfigToken["Colors"]["Success Color"] = SuccessColor.PlainSequence;
            Config.ConfigToken["Colors"]["User Dollar Color"] = UserDollarColor.PlainSequence;
            Config.ConfigToken["Colors"]["Tip Color"] = TipColor.PlainSequence;
            Config.ConfigToken["Colors"]["Separator Text Color"] = SeparatorTextColor.PlainSequence;
            Config.ConfigToken["Colors"]["Separator Color"] = SeparatorColor.PlainSequence;
            Config.ConfigToken["Colors"]["List Title Color"] = ListTitleColor.PlainSequence;
            Config.ConfigToken["Colors"]["Development Warning Color"] = DevelopmentWarningColor.PlainSequence;
            Config.ConfigToken["Colors"]["Stage Time Color"] = StageTimeColor.PlainSequence;
            Config.ConfigToken["Colors"]["Progress Color"] = ProgressColor.PlainSequence;
            Config.ConfigToken["Colors"]["Back Option Color"] = BackOptionColor.PlainSequence;
            Config.ConfigToken["Colors"]["Low Priority Border Color"] = LowPriorityBorderColor.PlainSequence;
            Config.ConfigToken["Colors"]["Medium Priority Border Color"] = MediumPriorityBorderColor.PlainSequence;
            Config.ConfigToken["Colors"]["High Priority Border Color"] = HighPriorityBorderColor.PlainSequence;
            Config.ConfigToken["Colors"]["Table Separator Color"] = TableSeparatorColor.PlainSequence;
            Config.ConfigToken["Colors"]["Table Header Color"] = TableHeaderColor.PlainSequence;
            Config.ConfigToken["Colors"]["Table Value Color"] = TableValueColor.PlainSequence;
            Config.ConfigToken["Colors"]["Selected Option Color"] = SelectedOptionColor.PlainSequence;
            Config.ConfigToken["Colors"]["Alternative Option Color"] = AlternativeOptionColor.PlainSequence;
