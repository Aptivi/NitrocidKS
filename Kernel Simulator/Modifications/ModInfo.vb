...
Public Class ModInfo
    ...
    ''' </summary>
    Friend Property ModParts As Dictionary(Of String, IScript)
    ''' <summary>
    ...
    ''' </summary>
    Friend Sub New(ModName As String, ModFileName As String, ModFilePath As String, ModParts As Dictionary(Of String, IScript), ModVersion As String)
