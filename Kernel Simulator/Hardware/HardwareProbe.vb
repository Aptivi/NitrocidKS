...
Public Module HardwareProbe
    ...
    Public Sub StartProbing()
        If Not quietProbe Then Write(DoTranslation("hwprobe: Your hardware will be probed. Please wait..."), True, ColTypes.Neutral)
        ...
        If Not quietProbe Then
            If HardwareInfo IsNot Nothing Then
                ...
                If HardwareInfo.Hardware.CPU Is Nothing Or (HardwareInfo.Hardware.CPU IsNot Nothing And HardwareInfo.Hardware.CPU.Count = 0) Then
                    ...
                    Write(DoTranslation("CPU: One or more of the CPU cores failed to be probed. Showing information anyway..."), True, ColTypes.Neutral)
                End If

                'then RAM
                If HardwareInfo.Hardware.RAM Is Nothing Then
                    Wdbg("E", "RAM failed to probe.")
                    Write(DoTranslation("RAM: One or more of the RAM chips failed to be probed. Showing information anyway..."), True, ColTypes.Neutral)
                End If

                'then GPU
                If HardwareInfo.Hardware.GPU Is Nothing Then
                    Wdbg("E", "GPU failed to probe.")
                    Write(DoTranslation("GPU: One or more of the graphics cards failed to be probed. Showing information anyway..."), True, ColTypes.Neutral)
                End If
                ...
                If HardwareInfo.Hardware.HDD Is Nothing Or (HardwareInfo.Hardware.HDD IsNot Nothing And HardwareInfo.Hardware.HDD.Count = 0) Then
                    ...
                    Write(DoTranslation("HDD: One or more of the hard drives failed to be probed. Showing information anyway..."), True, ColTypes.Neutral)
                End If
