...
Namespace Network.Mail
    Public Module MailHandlers
        ...
        Sub HandleWebAlert(sender As Object, e As WebAlertEventArgs)
            ...
            TextWriterColor.Write(e.Message, True, ColTypes.Warning)
            TextWriterColor.Write(DoTranslation("Opening URL... Make sure to follow the steps shown on the screen."), True, ColTypes.Neutral)
