...
Public Module FTPShell
    ...
    Public FTPCommands As New Dictionary(Of String, CommandInfo) From {{"currlocaldir", New CommandInfo("currlocaldir", ShellCommandType.FTPShell, False, 0)},
                                                                       {"currremotedir", New CommandInfo("currremotedir", ShellCommandType.FTPShell, False, 0)},
                                                                       {"connect", New CommandInfo("connect", ShellCommandType.FTPShell, True, 1)},
                                                                       {"changelocaldir", New CommandInfo("changelocaldir", ShellCommandType.FTPShell, True, 1)},
                                                                       {"changeremotedir", New CommandInfo("changeremotedir", ShellCommandType.FTPShell, True, 1)},
                                                                       {"cdl", New CommandInfo("cdl", ShellCommandType.FTPShell, True, 1)},
                                                                       {"cdr", New CommandInfo("cdr", ShellCommandType.FTPShell, True, 1)},
                                                                       {"delete", New CommandInfo("delete", ShellCommandType.FTPShell, True, 1)},
                                                                       ...
                                                                       {"download", New CommandInfo("download", ShellCommandType.FTPShell, True, 1)},
                                                                       ...
                                                                       {"listlocal", New CommandInfo("listlocal", ShellCommandType.FTPShell, False, 0)},
                                                                       {"lsl", New CommandInfo("lsl", ShellCommandType.FTPShell, False, 0)},
                                                                       {"listremote", New CommandInfo("listremote", ShellCommandType.FTPShell, False, 0)},
                                                                       ...
                                                                       {"move", New CommandInfo("move", ShellCommandType.FTPShell, True, 2)},
                                                                       {"mv", New CommandInfo("mv", ShellCommandType.FTPShell, True, 2)},
                                                                       {"copy", New CommandInfo("copy", ShellCommandType.FTPShell, True, 2)},
                                                                       {"cp", New CommandInfo("cp", ShellCommandType.FTPShell, True, 2)},
                                                                       {"upload", New CommandInfo("upload", ShellCommandType.FTPShell, True, 1)},
