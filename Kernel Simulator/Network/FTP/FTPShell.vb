...
Public Module FTPShell
    ...
    Public ReadOnly FTPCommands As New Dictionary(Of String, CommandInfo) From {{"connect", New CommandInfo("connect", ShellCommandType.FTPShell, "Connects to an FTP server (it must start with ""ftp://"" or ""ftps://"")", "<server>", True, 1, New FTP_ConnectCommand)},
                                                                                ...
                                                                                {"disconnect", New CommandInfo("disconnect", ShellCommandType.FTPShell, "Disconnects from server", "[-f]", False, 0, New FTP_DisconnectCommand)},
                                                                                ...
                                                                                {"lsl", New CommandInfo("lsl", ShellCommandType.FTPShell, "Lists local directory", "[-showdetails|-suppressmessages] [dir]", False, 0, New FTP_LslCommand)},
                                                                                {"lsr", New CommandInfo("lsr", ShellCommandType.FTPShell, "Lists remote directory", "[-showdetails] [dir]", False, 0, New FTP_LsrCommand)},
