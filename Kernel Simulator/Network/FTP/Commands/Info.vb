    ...
    Class FTP_InfoCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgs() As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            If FtpConnected Then
                ...
                TextWriterColor.Write(DoTranslation("Server address:") + " ", False, ColTypes.ListEntry)
                TextWriterColor.Write(ClientFTP.Host, False, ColTypes.ListEntry)
                TextWriterColor.Write(DoTranslation("Server port:") + " ", False, ColTypes.ListEntry)
                TextWriterColor.Write(ClientFTP.Port.ToString, False, ColTypes.ListEntry)
                TextWriterColor.Write(DoTranslation("Server type:") + " ", False, ColTypes.ListEntry)
                TextWriterColor.Write(ClientFTP.ServerType.ToString, False, ColTypes.ListEntry)
                TextWriterColor.Write(DoTranslation("Server system type:") + " ", False, ColTypes.ListEntry)
                TextWriterColor.Write(ClientFTP.SystemType, False, ColTypes.ListEntry)
