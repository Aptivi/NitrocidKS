...
Module TShell
    ...
    Public TShellCmds As String() = {"print", "printf", "printd", "printdf", "testevent", "probehw", "garbage", "panic", "panicf", "translate", "places", "loadmods", "debug", "rdebug", "testmd5", "testsha256", "testregexp", "colortest", "soundtest", "help", "exit"}
    Sub InitTShell()
