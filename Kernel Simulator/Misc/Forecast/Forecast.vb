...
Namespace Misc.Forecast
    Public Module Forecast
        ...
        Public Sub PrintWeatherInfo(CityID As String, APIKey As String)
            ...
            TextWriterColor.Write(DoTranslation("Weather: {0}"), True, ColTypes.Neutral, WeatherInfo.Weather)
            ...
            End If
            TextWriterColor.Write(DoTranslation("Temperature: {0}") + WeatherSpecifier, True, ColTypes.Neutral, WeatherInfo.Temperature.ToString("N2"))
            TextWriterColor.Write(DoTranslation("Feels like: {0}") + WeatherSpecifier, True, ColTypes.Neutral, WeatherInfo.FeelsLike.ToString("N2"))
            TextWriterColor.Write(DoTranslation("Wind speed: {0}") + " {1}", True, ColTypes.Neutral, WeatherInfo.WindSpeed.ToString("N2"), WindSpeedSpecifier)
            TextWriterColor.Write(DoTranslation("Wind direction: {0}") + "°", True, ColTypes.Neutral, WeatherInfo.WindDirection.ToString("N2"))
            TextWriterColor.Write(DoTranslation("Pressure: {0}") + " hPa", True, ColTypes.Neutral, WeatherInfo.Pressure.ToString("N2"))
            TextWriterColor.Write(DoTranslation("Humidity: {0}") + "%", True, ColTypes.Neutral, WeatherInfo.Humidity.ToString("N2"))
        End Sub
