...
Namespace Misc.Editors.TextEdit
    Public Module TextEditShellCommon
        ...
        Public ReadOnly TextEdit_Commands As New Dictionary(Of String, CommandInfo) From {
            ...
            {"addlines", New CommandInfo("addlines", ShellType.TextShell, "Adds the new lines at the end of the file", New CommandArgumentInfo(Array.Empty(Of String), False, 0), New TextEdit_AddLinesCommand)},
            {"clear", New CommandInfo("clear", ShellType.TextShell, "Clears the text file", New CommandArgumentInfo(Array.Empty(Of String), False, 0), New TextEdit_ClearCommand)},
            ...
            {"save", New CommandInfo("save", ShellType.TextShell, "Saves the file", New CommandArgumentInfo(Array.Empty(Of String), False, 0), New TextEdit_SaveCommand)}
        }
