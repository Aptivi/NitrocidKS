...
Namespace Misc.Screensaver.Displays
    Public Module FallingLineDisplay

        Friend FallingLine As New KernelThread("FallingLine screensaver thread", True, AddressOf FallingLine_DoWork)
        ...
        ''' <summary>
        ''' Handles the code of FallingLine
        ''' </summary>
        Sub FallingLine_DoWork()
            Try
                'Variables
                Dim RandomDriver As New Random()
                Dim CoveredPositions As New List(Of Tuple(Of Integer, Integer))
                Dim ColumnLine As Integer
                ...
                Do While True
                    ...
                    'Select the color
                    Dim ColorStorage As Color = Color.Empty
                    ...
                    For Fall As Integer = FallStart To FallEnd
                        ...
                        'Delay
                        SleepNoBlock(FallingLineDelay, FallingLine)
                    Next
