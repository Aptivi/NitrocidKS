...
namespace KS.Misc.Screensaver.Displays
{
    ...
    {
        private static bool snakeFillTrueColor = true;
        private static int snakeFillDelay = 10;
        private static int snakeFillMinimumRedColorLevel = 0;
        private static int snakeFillMinimumGreenColorLevel = 0;
        private static int snakeFillMinimumBlueColorLevel = 0;
        private static int snakeFillMinimumColorLevel = 0;
        private static int snakeFillMaximumRedColorLevel = 255;
        private static int snakeFillMaximumGreenColorLevel = 255;
        private static int snakeFillMaximumBlueColorLevel = 255;
        private static int snakeFillMaximumColorLevel = 255;
