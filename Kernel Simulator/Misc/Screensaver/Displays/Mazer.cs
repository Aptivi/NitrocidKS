...
namespace KS.Misc.Screensaver.Displays
{
    ...
    {
        private static int mazerNewMazeDelay = 10000;
        private static int mazerGenerationSpeed = 20;
        private static bool mazerHighlightUncovered = false;
    ...
    public class MazerDisplay : BaseScreensaver, IScreensaver
    {
        ...
        private static void GenerateMaze()
        {
            ...
            var edges = edgesArray.RandomizeArray();
