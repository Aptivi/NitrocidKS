...
Public Module TextEditShell
    ...
    Public ReadOnly TextEdit_Commands As New Dictionary(Of String, CommandInfo) From {{"addline", New CommandInfo("addline", ShellCommandType.TextShell, "Adds a new line with text at the end of the file", {"<text>"}, True, 1, New TextEdit_AddLineCommand)},
                                                                                      ...
                                                                                      {"editline", New CommandInfo("editline", ShellCommandType.TextShell, "Edits the specified line", {"<linenumber>"}, True, 1, New TextEdit_EditLineCommand)},
                                                                                      ...
                                                                                      {"querywordregex", New CommandInfo("querywordregex", ShellCommandType.TextShell, "Queries a word in a specified line or all lines using regular expressions", {"""<regex>"" <linenumber/all> [linenumber2]"}, True, 2, New TextEdit_QueryWordRegexCommand)},
                                                                                      ...
                                                                                      {"replaceregex", New CommandInfo("replaceregex", ShellCommandType.TextShell, "Replaces a word or phrase with another one using regular expressions", {"""<regex>"" ""<word/phrase>"""}, True, 2, New TextEdit_ReplaceRegexCommand)},
                                                                                      {"replaceinlineregex", New CommandInfo("replaceinlineregex", ShellCommandType.TextShell, "Replaces a word or phrase with another one in a line using regular expressions", {"""<regex>"" ""<word/phrase>"" <linenumber> [linenumber2]"}, True, 3, New TextEdit_ReplaceInlineRegexCommand)},
