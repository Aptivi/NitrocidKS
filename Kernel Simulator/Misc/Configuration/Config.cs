...
namespace KS.Misc.Configuration
{
    public static class Config
    {
        ...
        public static JObject GetNewConfigObject()
        {
            ...
            {
                { "User Name Shell Color", KernelColorTools.UserNameShellColor.PlainSequence },
                { "Host Name Shell Color", KernelColorTools.HostNameShellColor.PlainSequence },
                { "Continuable Kernel Error Color", KernelColorTools.ContKernelErrorColor.PlainSequence },
                { "Uncontinuable Kernel Error Color", KernelColorTools.UncontKernelErrorColor.PlainSequence },
                { "Text Color", KernelColorTools.NeutralTextColor.PlainSequence },
                { "License Color", KernelColorTools.LicenseColor.PlainSequence },
                { "Background Color", KernelColorTools.BackgroundColor.PlainSequence },
                { "Input Color", KernelColorTools.InputColor.PlainSequence },
                { "List Entry Color", KernelColorTools.ListEntryColor.PlainSequence },
                { "List Value Color", KernelColorTools.ListValueColor.PlainSequence },
                { "Kernel Stage Color", KernelColorTools.StageColor.PlainSequence },
                { "Error Text Color", KernelColorTools.ErrorColor.PlainSequence },
                { "Warning Text Color", KernelColorTools.WarningColor.PlainSequence },
                { "Option Color", KernelColorTools.OptionColor.PlainSequence },
                { "Banner Color", KernelColorTools.BannerColor.PlainSequence },
                { "Notification Title Color", KernelColorTools.NotificationTitleColor.PlainSequence },
                { "Notification Description Color", KernelColorTools.NotificationDescriptionColor.PlainSequence },
                { "Notification Progress Color", KernelColorTools.NotificationProgressColor.PlainSequence },
                { "Notification Failure Color", KernelColorTools.NotificationFailureColor.PlainSequence },
                { "Question Color", KernelColorTools.QuestionColor.PlainSequence },
                { "Success Color", KernelColorTools.SuccessColor.PlainSequence },
                { "User Dollar Color", KernelColorTools.UserDollarColor.PlainSequence },
                { "Tip Color", KernelColorTools.TipColor.PlainSequence },
                { "Separator Text Color", KernelColorTools.SeparatorTextColor.PlainSequence },
                { "Separator Color", KernelColorTools.SeparatorColor.PlainSequence },
                { "List Title Color", KernelColorTools.ListTitleColor.PlainSequence },
                { "Development Warning Color", KernelColorTools.DevelopmentWarningColor.PlainSequence },
                { "Stage Time Color", KernelColorTools.StageTimeColor.PlainSequence },
                { "Progress Color", KernelColorTools.ProgressColor.PlainSequence },
                { "Back Option Color", KernelColorTools.BackOptionColor.PlainSequence },
                { "Low Priority Border Color", KernelColorTools.LowPriorityBorderColor.PlainSequence },
                { "Medium Priority Border Color", KernelColorTools.MediumPriorityBorderColor.PlainSequence },
                { "High Priority Border Color", KernelColorTools.HighPriorityBorderColor.PlainSequence },
                { "Table Separator Color", KernelColorTools.TableSeparatorColor.PlainSequence },
                { "Table Header Color", KernelColorTools.TableHeaderColor.PlainSequence },
                { "Table Value Color", KernelColorTools.TableValueColor.PlainSequence },
                { "Selected Option Color", KernelColorTools.SelectedOptionColor.PlainSequence },
                { "Alternative Option Color", KernelColorTools.AlternativeOptionColor.PlainSequence }
            };
