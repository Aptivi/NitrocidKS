...
namespace KS.Misc.Writers.MiscWriters
{
    public static class WelcomeMessage
    {
        ...
        {
            TextWriterColor.Write(Kernel.Kernel.NewLine
                + "    Kernel Simulator  Copyright (C) 2018-2024  Aptivi" + Kernel.Kernel.NewLine
                + "    This program comes with ABSOLUTELY NO WARRANTY, not even " + Kernel.Kernel.NewLine
                + "    MERCHANTABILITY or FITNESS for particular purposes." + Kernel.Kernel.NewLine
                + "    This is free software, and you are welcome to redistribute it" + Kernel.Kernel.NewLine
                + "    under certain conditions; See COPYING file in source code." + Kernel.Kernel.NewLine,
                true, KernelColorTools.ColTypes.License);
