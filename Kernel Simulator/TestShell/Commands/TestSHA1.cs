...
namespace KS.TestShell.Commands
{
	class Test_TestSHA1Command : CommandExecutor, ICommand
	{
		...
		public override void Execute(string StringArgs, string[] ListArgs, string[] ListArgsOnly, string[] ListSwitchesOnly)
		{
			...
			TextWriterColor.Write(Encryption.GetEncryptedString(ListArgs[0], Encryption.Algorithms.SHA1), true, KernelColorTools.GetConsoleColor(KernelColorTools.ColTypes.Neutral));
