...
Namespace TestShell.Commands
    Class Test_TestDictWriterIntCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgs() As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            ...
            Write(DoTranslation("Normal integer dictionary:"), True, GetConsoleColor(ColTypes.Neutral))
            WriteList(NormalIntegerDict)
            Write(DoTranslation("Array integer dictionary:"), True, GetConsoleColor(ColTypes.Neutral))
