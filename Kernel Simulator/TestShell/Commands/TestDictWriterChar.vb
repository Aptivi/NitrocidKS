...
Namespace TestShell.Commands
    Class Test_TestDictWriterCharCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgs() As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            ...
            TextWriterColor.Write(DoTranslation("Normal char dictionary:"), True, ColTypes.Neutral)
            WriteList(NormalCharDict)
            TextWriterColor.Write(DoTranslation("Array char dictionary:"), True, ColTypes.Neutral)
