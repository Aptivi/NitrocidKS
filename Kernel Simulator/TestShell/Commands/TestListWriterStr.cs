...
namespace KS.TestShell.Commands
{
    class Test_TestListWriterStrCommand : CommandExecutor, ICommand
    {
        ...
        public override void Execute(string StringArgs, string[] ListArgs, string[] ListArgsOnly, string[] ListSwitchesOnly)
        {
            ...
            TextWriters.Write(Translate.DoTranslation("Normal string list:"), true, KernelColorTools.ColTypes.Neutral);
            ListWriterColor.WriteList(NormalStringList);
            TextWriters.Write(Translate.DoTranslation("Array string list:"), true, KernelColorTools.ColTypes.Neutral);
