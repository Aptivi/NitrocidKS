        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgs() As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            If CustomSavers.ContainsKey(ListArgs(0)) Then
                If SetCustomSaverSettings(ListArgs(0), ListArgs(1), ListArgs(2)) Then
                    TextWriterColor.Write(DoTranslation("Settings set successfully for screensaver") + " {0}.", True, ColTypes.Neutral, ListArgs(0))
                Else
                    TextWriterColor.Write(DoTranslation("Failed to set a setting for screensaver") + " {0}.", True, ColTypes.Error, ListArgs(0))
                End If
            Else
