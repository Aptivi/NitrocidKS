...
Module TestShellCommon
    ...
    Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {{"print", New CommandInfo("print", ShellCommandType.TestShell, "Prints a string to console using color type and line print", {"<Color> <Line> <Message>"}, True, 3, New Test_PrintCommand)},
                                                                                  ...
                                                                                  {"checksettingsentryvars", New CommandInfo("checksettingsentryvars", ShellCommandType.TestShell, "Checks all the KS settings to see if the variables are written correctly", {}, False, 0, New Test_CheckSettingsEntryVarsCommand)},
                                                                                  {"checklocallines", New CommandInfo("checklocallines", ShellCommandType.TestShell, "Checks all the localization text line numbers to see if they're all equal", {}, False, 0, New Test_CheckLocalLinesCommand)},
                                                                                  {"checkstrings", New CommandInfo("checkstrings", ShellCommandType.TestShell, "Checks to see if the translatable strings exist in the KS resources", {"<stringlistfile>"}, True, 1, New Test_CheckStringsCommand)},
                                                                                  {"sleeptook", New CommandInfo("sleeptook", ShellCommandType.TestShell, "How many milliseconds did it really take to sleep?", {"[-t] <sleepms>"}, True, 1, New Test_SleepTookCommand, False, False, False, False, False, New Action(AddressOf (New Test_SleepTookCommand).HelpHelper))},
                                                                                  {"getlinestyle", New CommandInfo("getlinestyle", ShellCommandType.TestShell, "Gets the line ending style from text file", {"<textfile>"}, True, 1, New Test_GetLineStyleCommand)},
                                                                                  {"printfiglet", New CommandInfo("printfiglet", ShellCommandType.TestShell, "Prints a string to console using color type and line print with Figlet support", {"<Color> <FigletFont> <Message>"}, True, 3, New Test_PrintFigletCommand)},
                                                                                  {"printfigletf", New CommandInfo("printfigletf", ShellCommandType.TestShell, "Prints a string to console using color type and line print with format and Figlet support", {"<Color> <FigletFont> <Variable1;Variable2;Variable3;...> <Message>"}, True, 4, New Test_PrintFigletFCommand)},
