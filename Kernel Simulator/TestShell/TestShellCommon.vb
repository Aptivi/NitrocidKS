...
Namespace TestShell
    Module TestShellCommon
        ...
        Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {
            {"print", New CommandInfo("print", ShellType.TestShell, "Prints a string to console using color type and line print", {"<Color> <Line> <Message>"}, True, 3, New Test_PrintCommand)},
            ...
            {"printdf", New CommandInfo("printdf", ShellType.TestShell, "Prints a string to debugger with format support", {"<Variable1;Variable2;Variable3;...> <Message>"}, True, 2, New Test_PrintDFCommand)},
            {"printsep", New CommandInfo("printsep", ShellType.TestShell, "Prints a separator", {"<Message>"}, True, 1, New Test_PrintSepCommand)},
            {"printsepf", New CommandInfo("printsepf", ShellType.TestShell, "Prints a separator with format support", {"<Variable1;Variable2;Variable3;...> <Message>"}, True, 2, New Test_PrintSepCommand)},
            ...
            {"printsepcolorf", New CommandInfo("printsepcolorf", ShellType.TestShell, "Prints a separator with color and format support", {"<Color> <Variable1;Variable2;Variable3;...> <Message>"}, True, 3, New Test_PrintSepColorFCommand)},
            ...
            {"probehw", New CommandInfo("probehw", ShellType.TestShell, "Tests probing the hardware", Array.Empty(Of String), False, 0, New Test_ProbeHwCommand)},
            ...
            {"loadmods", New CommandInfo("loadmods", ShellType.TestShell, "Starts all mods", Array.Empty(Of String), False, 0, New Test_LoadModsCommand)},
            {"stopmods", New CommandInfo("stopmods", ShellType.TestShell, "Stops all mods", Array.Empty(Of String), False, 0, New Test_StopModsCommand)},
            {"reloadmods", New CommandInfo("reloadmods", ShellType.TestShell, "Reloads all mods", Array.Empty(Of String), False, 0, New Test_ReloadModsCommand)},
            ...
            {"colorwheel", New CommandInfo("colorwheel", ShellType.TestShell, "Tests the color wheel", Array.Empty(Of String), False, 0, New Test_ColorWheelCommand)},
            ...
            {"listcodepages", New CommandInfo("listcodepages", ShellType.TestShell, "Lists all supported codepages", Array.Empty(Of String), False, 0, New Test_ListCodePagesCommand)},
            {"lscompilervars", New CommandInfo("lscompilervars", ShellType.TestShell, "What compiler variables are enabled in the application?", Array.Empty(Of String), False, 0, New Test_LsCompilerVarsCommand)},
            {"testdictwriterstr", New CommandInfo("testdictwriterstr", ShellType.TestShell, "Tests the dictionary writer with the string and string array", Array.Empty(Of String), False, 0, New Test_TestDictWriterStrCommand)},
            {"testdictwriterint", New CommandInfo("testdictwriterint", ShellType.TestShell, "Tests the dictionary writer with the integer and integer array", Array.Empty(Of String), False, 0, New Test_TestDictWriterIntCommand)},
            {"testdictwriterchar", New CommandInfo("testdictwriterchar", ShellType.TestShell, "Tests the dictionary writer with the char and char array", Array.Empty(Of String), False, 0, New Test_TestDictWriterCharCommand)},
            {"testlistwriterstr", New CommandInfo("testlistwriterstr", ShellType.TestShell, "Tests the list writer with the string and string array", Array.Empty(Of String), False, 0, New Test_TestListWriterStrCommand)},
            {"testlistwriterint", New CommandInfo("testlistwriterint", ShellType.TestShell, "Tests the list writer with the integer and integer array", Array.Empty(Of String), False, 0, New Test_TestListWriterIntCommand)},
            {"testlistwriterchar", New CommandInfo("testlistwriterchar", ShellType.TestShell, "Tests the list writer with the char and char array", Array.Empty(Of String), False, 0, New Test_TestListWriterCharCommand)},
            ...
            {"showtime", New CommandInfo("showtime", ShellType.TestShell, "Shows local kernel time", Array.Empty(Of String), False, 0, New Test_ShowTimeCommand)},
            {"showdate", New CommandInfo("showdate", ShellType.TestShell, "Shows local kernel date", Array.Empty(Of String), False, 0, New Test_ShowDateCommand)},
            {"showtd", New CommandInfo("showtd", ShellType.TestShell, "Shows local kernel date and time", Array.Empty(Of String), False, 0, New Test_ShowTDCommand)},
            {"showtimeutc", New CommandInfo("showtimeutc", ShellType.TestShell, "Shows UTC kernel time", Array.Empty(Of String), False, 0, New Test_ShowTimeUtcCommand)},
            {"showdateutc", New CommandInfo("showdateutc", ShellType.TestShell, "Shows UTC kernel date", Array.Empty(Of String), False, 0, New Test_ShowDateUtcCommand)},
            {"showtdutc", New CommandInfo("showtdutc", ShellType.TestShell, "Shows UTC kernel date and time", Array.Empty(Of String), False, 0, New Test_ShowTDUtcCommand)},
            ...
            {"checksettingsentryvars", New CommandInfo("checksettingsentryvars", ShellType.TestShell, "Checks all the KS settings to see if the variables are written correctly", Array.Empty(Of String), False, 0, New Test_CheckSettingsEntryVarsCommand)},
            {"checklocallines", New CommandInfo("checklocallines", ShellType.TestShell, "Checks all the localization text line numbers to see if they're all equal", Array.Empty(Of String), False, 0, New Test_CheckLocalLinesCommand)},
            ...
            {"printfigletf", New CommandInfo("printfigletf", ShellType.TestShell, "Prints a string to console using color type and line print with format and Figlet support", {"<Color> <FigletFont> <Variable1;Variable2;Variable3;...> <Message>"}, True, 4, New Test_PrintFigletFCommand)},
            {"powerlinetest", New CommandInfo("powerlinetest", ShellType.TestShell, "Tests your console for PowerLine support", Array.Empty(Of String), False, 0, New Test_PowerLineTestCommand)},
            {"testexecuteasm", New CommandInfo("testexecuteasm", ShellType.TestShell, "Tests assembly entry point execution", {"<pathtoasm>"}, True, 1, New Test_TestExecuteAsmCommand)},
            {"help", New CommandInfo("help", ShellType.TestShell, "Shows help screen", {"[command]"}, False, 0, New Test_HelpCommand)},
            {"exit", New CommandInfo("exit", ShellType.TestShell, "Exits the test shell and starts the kernel", Array.Empty(Of String), False, 0, New Test_ExitCommand)},
            {"shutdown", New CommandInfo("shutdown", ShellType.TestShell, "Exits the test shell and shuts down the kernel", Array.Empty(Of String), False, 0, New Test_ShutdownCommand)}
        }
