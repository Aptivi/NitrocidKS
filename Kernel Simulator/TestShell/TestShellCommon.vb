...
Module TestShellCommon
    ...
    Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {{"print", New CommandInfo("print", ShellType.TestShell, "Prints a string to console using color type and line print", {"<Color> <Line> <Message>"}, True, 3, New Test_PrintCommand)},
                                                                                  ...
                                                                                  {"garbage", New CommandInfo("garbage", ShellType.TestShell, "Tests the garbage collector", {}, False, 0, New Test_GarbageCommand)},
                                                                                  ...
                                                                                  {"sleeptook", New CommandInfo("sleeptook", ShellType.TestShell, "How many milliseconds did it really take to sleep?", {"[-t] <sleepms>"}, True, 1, New Test_SleepTookCommand, False, False, False, False, False, New Action(AddressOf (New Test_SleepTookCommand).HelpHelper))},
