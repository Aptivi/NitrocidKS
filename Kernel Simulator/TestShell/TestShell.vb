...
Module TestShell
    ...
    Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {{"print", New CommandInfo("print", ShellCommandType.TestShell, "Prints a string to console using color type and line print", True, 3)},
                                                                                  {"printf", New CommandInfo("printf", ShellCommandType.TestShell, "Prints a string to console using color type and line print with format support", True, 4)},
                                                                                  {"printd", New CommandInfo("printd", ShellCommandType.TestShell, "Prints a string to debugger", True, 1)},
                                                                                  {"printdf", New CommandInfo("printdf", ShellCommandType.TestShell, "Prints a string to debugger with format support", True, 2)},
                                                                                  {"printsep", New CommandInfo("printsep", ShellCommandType.TestShell, "Prints a separator", True, 1)},
                                                                                  {"printsepf", New CommandInfo("printsepf", ShellCommandType.TestShell, "Prints a separator with format support", True, 2)},
                                                                                  {"printsepcolor", New CommandInfo("printsepcolor", ShellCommandType.TestShell, "Prints a separator with color support", True, 2)},
                                                                                  {"printsepcolorf", New CommandInfo("printsepcolorf", ShellCommandType.TestShell, "Prints a separator with color and format support", True, 3)},
                                                                                  {"testevent", New CommandInfo("testevent", ShellCommandType.TestShell, "Tests raising the specific event", True, 1)},
                                                                                  ...
                                                                                  {"panic", New CommandInfo("panic", ShellCommandType.TestShell, "Tests the kernel error facility", True, 4)},
                                                                                  {"panicf", New CommandInfo("panicf", ShellCommandType.TestShell, "Tests the kernel error facility with format support", True, 5)},
                                                                                  {"translate", New CommandInfo("translate", ShellCommandType.TestShell, "Tests translating a string that exists in resources to specific language", True, 2)},
                                                                                  {"places", New CommandInfo("places", ShellCommandType.TestShell, "Prints a string to console and parses the placeholders found", True, 1)},
                                                                                  {"testsha512", New CommandInfo("testsha512", ShellCommandType.TestShell, "Encrypts a string using" + " SHA512", True, 1)},
                                                                                  {"testsha256", New CommandInfo("testsha256", ShellCommandType.TestShell, "Encrypts a string using" + " SHA256", True, 1)},
                                                                                  {"testsha1", New CommandInfo("testsha1", ShellCommandType.TestShell, "Encrypts a string using" + " SHA1", True, 1)},
                                                                                  {"testmd5", New CommandInfo("testmd5", ShellCommandType.TestShell, "Encrypts a string using" + " MD5", True, 1)},
                                                                                  {"testregexp", New CommandInfo("testregexp", ShellCommandType.TestShell, "Tests the regular expression facility", True, 2)},
                                                                                  ...
                                                                                  {"debug", New CommandInfo("debug", ShellCommandType.TestShell, "Enables or disables debug", True, 1)},
                                                                                  {"rdebug", New CommandInfo("rdebug", ShellCommandType.TestShell, "Enables or disables remote debug", True, 1)},
                                                                                  {"colortest", New CommandInfo("colortest", ShellCommandType.TestShell, "Tests the VT sequence for 255 colors", True, 1)},
                                                                                  {"colortruetest", New CommandInfo("colortruetest", ShellCommandType.TestShell, "Tests the VT sequence for true color", True, 1)},
                                                                                  {"sendnot", New CommandInfo("sendnot", ShellCommandType.TestShell, "Sends a notification to test the receiver", True, 3)},
                                                                                  {"dcalend", New CommandInfo("dcalend", ShellCommandType.TestShell, "Tests printing date using different calendars", True, 1)},
                                                                                  ...
                                                                                  {"lscultures", New CommandInfo("lscultures", ShellCommandType.TestShell, "Lists supported cultures", False, 0)},
                                                                                  {"getcustomsaversetting", New CommandInfo("getcustomsaversetting", ShellCommandType.TestShell, "Gets custom saver settings", True, 2)},
                                                                                  {"setcustomsaversetting", New CommandInfo("setcustomsaversetting", ShellCommandType.TestShell, "Sets custom saver settings", True, 3)},
                                                                                  {"help", New CommandInfo("help", ShellCommandType.TestShell, "Shows help screen", False, 0)},
