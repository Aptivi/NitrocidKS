...
Module TestShell
    ...
    Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {{"print", New CommandInfo("print", ShellCommandType.TestShell, True, 3)},
                                                                                  ...
                                                                                  {"printsep", New CommandInfo("printsep", ShellCommandType.TestShell, True, 1)},
                                                                                  {"printsepf", New CommandInfo("printsepf", ShellCommandType.TestShell, True, 2)},
                                                                                  {"printsepcolor", New CommandInfo("printsepcolor", ShellCommandType.TestShell, True, 2)},
                                                                                  {"printsepcolorf", New CommandInfo("printsepcolorf", ShellCommandType.TestShell, True, 3)},
                                                                                  ...
                                                                                  {"loadmods", New CommandInfo("loadmods", ShellCommandType.TestShell, False, 0)},
                                                                                  {"stopmods", New CommandInfo("stopmods", ShellCommandType.TestShell, False, 0)},
