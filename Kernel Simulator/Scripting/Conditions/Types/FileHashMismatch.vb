...
Namespace Scripting.Conditions.Types
    Public Class FileHashMismatchCondition
        ...
        Public Overrides ReadOnly Property ConditionPosition As Integer = 3 Implements ICondition.ConditionPosition
        ...
        Public Overrides Function IsConditionSatisfied(FirstVariable As String, SecondVariable As String) As Boolean Implements ICondition.IsConditionSatisfied
            Return UESHVariableFileHashNoMatch(FirstVariable, SecondVariable)
        End Function
