...
Namespace Scripting.Conditions.Types
    Public Class DirectoryExistsCondition
        ...
        Public Overrides ReadOnly Property ConditionPosition As ConditionPosition = ConditionPosition.First Implements ICondition.ConditionPosition
        ...
        Public Overrides Function IsConditionSatisfied(FirstVariable As String, SecondVariable As String) As Boolean Implements ICondition.IsConditionSatisfied
            Return UESHVariableDirectoryExists(FirstVariable)
        End Function
