...
namespace KS.Scripting.Interaction
{
    public static class UESHCommands
    {
        ...
        public static void PromptChoiceAndSet(string Question, string ScriptVariable, string AnswersStr, ChoiceStyle.ChoiceOutputType OutputType = ChoiceStyle.ChoiceOutputType.OneLine, bool PressEnter = false)
        {
