...
namespace KS.Shell.Prompts.Presets.UESH
{
    public class PowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            var UserNameShellColorSegmentForeground = new Color(255, 85, 255);
            var UserNameShellColorSegmentBackground = new Color(25, 25, 25);
            var HostNameShellColorSegmentForeground = new Color(255, 85, 255);
            var HostNameShellColorSegmentBackground = new Color(25, 25, 25);
            var CurrentDirectoryShellColorSegmentForeground = new Color(255, 85, 255);
