...
Namespace Shell.Prompts.Presets.Json
    Public Class JsonDefaultPreset
        ...
        Public Overrides ReadOnly Property PresetShellType As ShellType = ShellType.JsonShell Implements IPromptPreset.PresetShellType
        ...
        Friend Overrides Function PresetPromptBuilder() As String Implements IPromptPreset.PresetPromptBuilder
            ...
            PresetStringBuilder.AppendFormat(Path.GetFileName(JsonShell_FileStream.Name))

            'Was file edited?
            PresetStringBuilder.Append(UserNameShellColor.VTSequenceForeground)
            PresetStringBuilder.AppendFormat("{0}", If(JsonShell_WasJsonEdited(), "*", ""))
