...
{
    public class RarPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            PresetStringBuilder.AppendFormat(" {0} ", Path.GetFileName(RarShellCommon.RarShell_FileStream.Name));
            ...
            PresetStringBuilder.Append(SecondColorSegmentBackground.VTSequenceBackground);
            PresetStringBuilder.AppendFormat(" {0} ", RarShellCommon.RarShell_CurrentArchiveDirectory);
