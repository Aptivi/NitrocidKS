...
Namespace Shell.Prompts.Presets.RAR
    Public Class RarPowerLine2Preset
        ...
        Public Overrides ReadOnly Property PresetShellType As ShellType = ShellType.RARShell Implements IPromptPreset.PresetShellType
        ...
        Friend Overrides Function PresetPromptBuilder() As String Implements IPromptPreset.PresetPromptBuilder
            ...
            Dim SecondColorSegmentBackground As New Color(255, 85, 255)
            ...
            PresetStringBuilder.AppendFormat(" {0} ", Path.GetFileName(RarShell_FileStream.Name))
