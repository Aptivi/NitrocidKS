...
Namespace Shell.Prompts.Presets.ZIP
    Public Class ZipPowerLineBG2Preset
        ...
        Friend Overrides Function PresetPromptBuilder() As String Implements IPromptPreset.PresetPromptBuilder
            ...
            Dim UserNameShellColorSegmentForeground As New Color(255, 85, 255)
            Dim UserNameShellColorSegmentBackground As New Color(25, 25, 25)
            Dim HostNameShellColorSegmentForeground As New Color(255, 85, 255)
            Dim HostNameShellColorSegmentBackground As New Color(25, 25, 25)
            Dim CurrentDirectoryShellColorSegmentForeground As New Color(255, 85, 255)
