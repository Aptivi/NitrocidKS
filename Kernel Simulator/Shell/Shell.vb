...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellType.Shell, "Adds users", {"<userName> [password] [confirm]"}, True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"cat", New CommandInfo("cat", ShellType.Shell, "Prints content of file to console", {"[-lines|-nolines] <file>"}, True, 1, New CatCommand, False, True, False, False, False, New Action(AddressOf (New CatCommand).HelpHelper))},
                                                                             {"cdbglog", New CommandInfo("cdbglog", ShellType.Shell, "Deletes everything in debug log", {}, False, 0, New CdbgLogCommand, True)},
                                                                             {"chattr", New CommandInfo("chattr", ShellType.Shell, "Changes attribute of a file", {"<file> +/-<attributes>"}, True, 2, New ChAttrCommand, False, False, False, False, False, New Action(AddressOf (New ChAttrCommand).HelpHelper))},
                                                                             ...
                                                                             {"chlang", New CommandInfo("chlang", ShellType.Shell, "Changes language", {"[-alwaystransliterated|-alwaystranslated|-force] <language>"}, True, 1, New ChLangCommand, True, False, False, False, False, New Action(AddressOf (New ChLangCommand).HelpHelper))},
                                                                             ...
                                                                             {"choice", New CommandInfo("choice", ShellType.Shell, "Makes user choices", {"[-o|-t|-m|-a] [-multiple|-single] <$variable> <answers> <input> [answertitle1] [answertitle2] ..."}, True, 3, New ChoiceCommand, False, False, False, False, True, New Action(AddressOf (New ChoiceCommand).HelpHelper))},
                                                                             ...
                                                                             {"hwinfo", New CommandInfo("hwinfo", ShellType.Shell, "Prints hardware information", {"<HardwareType>"}, True, 1, New HwInfoCommand, False, True, False, False, False, New Action(AddressOf (New HwInfoCommand).HelpHelper))},
                                                                             ...
                                                                             {"list", New CommandInfo("list", ShellType.Shell, "List file/folder contents in current folder", {"[-showdetails|-suppressmessages] [directory]"}, False, 0, New ListCommand, False, True, False, False, False, New Action(AddressOf (New ListCommand).HelpHelper))},
                                                                             ...
                                                                             {"reloadconfig", New CommandInfo("reloadconfig", ShellType.Shell, "Reloads configuration file that is edited.", {}, False, 0, New ReloadConfigCommand, True, False, False, False, True, New Action(AddressOf (New ReloadConfigCommand).HelpHelper))},
                                                                             {"reloadsaver", New CommandInfo("reloadsaver", ShellType.Shell, "Reloads screensaver file in KSMods", {"<customsaver>"}, True, 1, New ReloadSaverCommand, True, False, False, False, True, New Action(AddressOf (New ReloadSaverCommand).HelpHelper))},
                                                                             ...
                                                                             {"saversettings", New CommandInfo("settings", ShellType.Shell, "Changes screensaver configuration", {}, False, 0, New SaverSettingsCommand, True)},
                                                                             ...
                                                                             {"setsaver", New CommandInfo("setsaver", ShellType.Shell, "Sets up kernel screensavers", {"<customsaver/builtinsaver>"}, True, 1, New SetSaverCommand, True, False, False, False, False, New Action(AddressOf (New SetSaverCommand).HelpHelper))},
                                                                             {"setthemes", New CommandInfo("setthemes", ShellType.Shell, "Sets up kernel themes", {"<Theme>"}, True, 1, New SetThemesCommand, False, False, False, False, False, New Action(AddressOf (New SetThemesCommand).HelpHelper))},
                                                                             {"settings", New CommandInfo("settings", ShellType.Shell, "Changes kernel configuration", {}, False, 0, New SettingsCommand, True)},
                                                                             ...
                                                                             {"showtdzone", New CommandInfo("showtdzone", ShellType.Shell, "Shows date and time in zones", {"[-all] <timezone>"}, True, 1, New ShowTdZoneCommand, False, True, False, False, False, New Action(AddressOf (New ShowTdZoneCommand).HelpHelper))},
                                                                             {"shutdown", New CommandInfo("shutdown", ShellType.Shell, "The kernel will be shut down", {"[ip] [port]"}, False, 0, New ShutdownCommand)},
                                                                             {"speedpress", New CommandInfo("speedpress", ShellType.Shell, "See if you can press a key on time", {"[-e|-m|-h|-v|-c] [timeout]"}, False, 0, New SpeedPressCommand, False, False, False, False, False, New Action(AddressOf (New SpeedPressCommand).HelpHelper))},
                                                                             ...
                                                                             {"sysinfo", New CommandInfo("sysinfo", ShellType.Shell, "System information", {"[-s|-h|-u|-m|-l|-a]"}, False, 0, New SysInfoCommand, False, False, False, False, False, New Action(AddressOf (New SysInfoCommand).HelpHelper))},
                                                                             ...
                                                                             {"unzip", New CommandInfo("unzip", ShellType.Shell, "Extracts a ZIP archive", {"<zipfile> [path] [-createdir]"}, True, 1, New UnZipCommand, False, False, False, False, False, New Action(AddressOf (New UnZipCommand).HelpHelper))},
                                                                             {"update", New CommandInfo("update", ShellType.Shell, "System update", {}, False, 0, New UpdateCommand, True)},
                                                                             {"usermanual", New CommandInfo("usermanual", ShellType.Shell, "Takes you to our GitHub Wiki.", {}, False, 0, New UserManualCommand)},
                                                                             ...
                                                                             {"weather", New CommandInfo("weather", ShellType.Shell, "Shows weather info for specified city. Uses OpenWeatherMap.", {"[-list] <CityID/CityName> [apikey]"}, True, 1, New WeatherCommand, False, False, False, False, True, New Action(AddressOf (New WeatherCommand).HelpHelper))},
                                                                             {"wrap", New CommandInfo("wrap", ShellType.Shell, "Wraps the console output", {"<command>"}, True, 1, New WrapCommand, False, False, False, False, True, New Action(AddressOf (New WrapCommand).HelpHelper))},
            ...
            If Not (strcommand = Nothing Or strcommand.StartsWithAnyOf({" ", "#"}) = True) Then
                ...
                If Commands.ContainsKey(strcommand) Then
                    ...
                    ElseIf (HasPermission(CurrentUser.Username, PermissionType.Administrator) And Commands(strcommand).Strict) Or Commands.ContainsKey(strcommand) Then
                        ...
                        Dim Params As New ExecuteCommandThreadParameters(EntireCommand, ShellType.Shell, Nothing)
