...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, "Adds users", "<userName> [password] [confirm]", True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"choice", New CommandInfo("choice", ShellCommandType.Shell, "Makes user choices", "[-o|-t|-m|-a] <$variable> <answers> <input>", True, 3, New ChoiceCommand, False, False, False, False, True, New Action(AddressOf (New ChoiceCommand).HelpHelper))},
