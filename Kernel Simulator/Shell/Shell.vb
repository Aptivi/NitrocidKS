...
Public Module Shell
    ...
    ''' List of commands
    ''' </summary>
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, True, 1, True)},
                                                                             ...
                                                                             {"choice", New CommandInfo("choice", ShellCommandType.Shell, True, 3, False, False, False, False, True)},
                                                                             ...
                                                                             {"input", New CommandInfo("input", ShellCommandType.Shell, True, 2, False, False, False, False, True)},
                                                                             ...
                                                                             {"set", New CommandInfo("set", ShellCommandType.Shell, True, 2, False, False, False, False, True)},
