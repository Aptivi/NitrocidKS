...
Public Module Shell
    ...
    Public availableCommands() As String = {"help", "logout", "list", "chdir", "cdir", "read", "shutdown", "reboot", "adduser", "chmotd",
                                            ...
                                            "setthemes", "netinfo", "md", "rd", "reloadconfig", "showtdzone", "alias", "chmal",
                                            ...
                                            "dismissnotif", "rexec", "calc", "update", "sumfiles"}
    Public strictCmds() As String = {"adduser", "perm", "arginj", "chhostname", "chmotd", "chusrname", "rmuser", "netinfo",
