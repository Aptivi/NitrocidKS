...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, "Adds users", {"<userName> [password] [confirm]"}, True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"langman", New CommandInfo("langman", ShellCommandType.Shell, "Manage your languages", {"<reload/install/load/uninstall/unload> <customlanguagename>", "<list/reloadall>"}, True, 1, New LangManCommand, True)},
