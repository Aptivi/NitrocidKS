...
Public Module Shell
    ...
    ''' List of commands
    ''' </summary>
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, "Adds users", True, 1, True)},
                                                                             {"alias", New CommandInfo("alias", ShellCommandType.Shell, "Adds aliases to commands", True, 3, True)},
                                                                             {"arginj", New CommandInfo("arginj", ShellCommandType.Shell, "Injects arguments to the kernel (reboot required)", True, 1, True)},
                                                                             {"beep", New CommandInfo("beep", ShellCommandType.Shell, "Beep in 'n' Hz and time in 'n' milliseconds", True, 2)},
                                                                             {"blockdbgdev", New CommandInfo("blockdbgdev", ShellCommandType.Shell, "Block a debug device by IP address", True, 1, True)},
                                                                             {"calc", New CommandInfo("calc", ShellCommandType.Shell, "Calculator to calculate expressions.", True, 1)},
                                                                             {"cat", New CommandInfo("cat", ShellCommandType.Shell, "Prints content of file to console", True, 1, False, True)},
                                                                             {"cdbglog", New CommandInfo("cdbglog", ShellCommandType.Shell, "Deletes everything in debug log", False, 0, True)},
                                                                             {"chattr", New CommandInfo("chattr", ShellCommandType.Shell, "Changes attribute of a file", True, 2)},
                                                                             {"chdir", New CommandInfo("chdir", ShellCommandType.Shell, "Changes directory", True, 1)},
                                                                             {"chhostname", New CommandInfo("chhostname", ShellCommandType.Shell, "Changes host name", True, 1, True)},
                                                                             {"chlang", New CommandInfo("chlang", ShellCommandType.Shell, "Changes language", True, 1, True)},
                                                                             {"chmal", New CommandInfo("chmal", ShellCommandType.Shell, "Changes MAL, the MOTD After Login", False, 0, True)},
                                                                             {"chmotd", New CommandInfo("chmotd", ShellCommandType.Shell, "Changes MOTD, the Message Of The Day", False, 0, True)},
                                                                             {"choice", New CommandInfo("choice", ShellCommandType.Shell, "Makes user choices", True, 3, False, False, False, False, True)},
                                                                             {"chpwd", New CommandInfo("chpwd", ShellCommandType.Shell, "Changes password for current user", True, 4, True)},
                                                                             {"chusrname", New CommandInfo("chusrname", ShellCommandType.Shell, "Changes user name", True, 2, True)},
                                                                             {"cls", New CommandInfo("cls", ShellCommandType.Shell, "Clears the screen", False, 0)},
                                                                             {"copy", New CommandInfo("copy", ShellCommandType.Shell, "Creates another copy of a file under different directory or name.", True, 2)},
                                                                             {"dirinfo", New CommandInfo("dirinfo", ShellCommandType.Shell, "Provides information about a directory", True, 1)},
                                                                             {"disconndbgdev", New CommandInfo("disconndbgdev", ShellCommandType.Shell, "Disconnect a debug device", True, 1, True)},
                                                                             {"dismissnotif", New CommandInfo("dismissnotif", ShellCommandType.Shell, "Dismisses a notification", True, 1)},
                                                                             {"echo", New CommandInfo("echo", ShellCommandType.Shell, "Writes text into the console", False, 0)},
                                                                             {"edit", New CommandInfo("edit", ShellCommandType.Shell, "Edits a text file", True, 1)},
                                                                             {"fileinfo", New CommandInfo("fileinfo", ShellCommandType.Shell, "Provides information about a file", True, 1)},
                                                                             {"firedevents", New CommandInfo("firedevents", ShellCommandType.Shell, "Lists all fired events", False, 0)},
                                                                             {"ftp", New CommandInfo("ftp", ShellCommandType.Shell, "Use an FTP shell to interact with servers", False, 0)},
                                                                             {"gettimeinfo", New CommandInfo("gettimeinfo", ShellCommandType.Shell, "Gets the date and time information", True, 1)},
                                                                             {"get", New CommandInfo("get", ShellCommandType.Shell, "Downloads a file to current working directory", True, 1)},
                                                                             {"help", New CommandInfo("help", ShellCommandType.Shell, "Help page", False, 0)},
                                                                             ...
                                                                             {"lsmail", New CommandInfo("lsmail", ShellCommandType.Shell, "Lists all mails in the specific user.", False, 0)},
                                                                             {"mathbee", New CommandInfo("mathbee", ShellCommandType.Shell, "See if you can solve mathematical equations on time", False, 0)},
                                                                             {"md", New CommandInfo("md", ShellCommandType.Shell, "Creates a directory", True, 1)},
                                                                             {"mkfile", New CommandInfo("mkfile", ShellCommandType.Shell, "Makes a new file", True, 1)},
                                                                             {"mktheme", New CommandInfo("mktheme", ShellCommandType.Shell, "Makes a new theme", True, 1)},
                                                                             {"modinfo", New CommandInfo("modinfo", ShellCommandType.Shell, "Gets mod information", True, 1)},
                                                                             ...
                                                                             {"ping", New CommandInfo("ping", ShellCommandType.Shell, "Pings an address", True, 1)},
                                                                             {"put", New CommandInfo("put", ShellCommandType.Shell, "Uploads a file to specified website", True, 2)},
                                                                             {"reboot", New CommandInfo("reboot", ShellCommandType.Shell, "Restarts your computer (WARNING: No syncing, because it is not a final kernel)", False, 0)},
                                                                             {"reloadconfig", New CommandInfo("reloadconfig", ShellCommandType.Shell, "Reloads configuration file that is edited.", False, 0, True)},
                                                                             {"reloadmods", New CommandInfo("reloadmods", ShellCommandType.Shell, "Reloads mods.", False, 0, True)},
                                                                             {"reloadsaver", New CommandInfo("reloadsaver", ShellCommandType.Shell, "Reloads screensaver file in KSMods", True, 1, True)},
                                                                             {"rexec", New CommandInfo("rexec", ShellCommandType.Shell, "Remotely executes a command to remote PC", True, 2, True)},
                                                                             {"rm", New CommandInfo("rm", ShellCommandType.Shell, "Removes a directory or a file", True, 1)},
                                                                             ...
                                                                             {"rmuser", New CommandInfo("rmuser", ShellCommandType.Shell, "Removes a user from the list", True, 1, True)},
                                                                             {"rss", New CommandInfo("rss", ShellCommandType.Shell, "Opens an RSS shell to read the feeds", False, 0)},
                                                                             ...
                                                                             {"savescreen", New CommandInfo("savescreen", ShellCommandType.Shell, "Saves your screen from burn outs", False, 0)},
                                                                             {"search", New CommandInfo("search", ShellCommandType.Shell, "Searches for specified string in the provided file using regular expressions", True, 2)},
                                                                             {"searchword", New CommandInfo("searchword", ShellCommandType.Shell, "Searches for specified string in the provided file", True, 2)},
                                                                             {"setsaver", New CommandInfo("setsaver", ShellCommandType.Shell, "Sets up kernel screensavers", True, 1, True)},
                                                                             {"setthemes", New CommandInfo("setthemes", ShellCommandType.Shell, "Sets up kernel themes", True, 1)},
                                                                             {"settings", New CommandInfo("settings", ShellCommandType.Shell, "Changes kernel configuration", False, 0, True)},
                                                                             {"set", New CommandInfo("set", ShellCommandType.Shell, "Sets a variable to a value in a script", True, 2, False, False, False, False, True)},
                                                                             {"sftp", New CommandInfo("sftp", ShellCommandType.Shell, "Lets you use an SSH FTP server", False, 0)},
                                                                             ...
                                                                             {"showtdzone", New CommandInfo("showtdzone", ShellCommandType.Shell, "Shows date and time in zones", True, 1, False, True)},
                                                                             {"shutdown", New CommandInfo("shutdown", ShellCommandType.Shell, "The kernel will be shut down", False, 0)},
                                                                             {"speedpress", New CommandInfo("speedpress", ShellCommandType.Shell, "See if you can press a key on time", True, 1)},
                                                                             {"spellbee", New CommandInfo("spellbee", ShellCommandType.Shell, "See if you can spell words correctly on time", False, 0)},
                                                                             {"sshell", New CommandInfo("sshell", ShellCommandType.Shell, "Connects to an SSH server.", True, 2)},
                                                                             {"sshcmd", New CommandInfo("sshcmd", ShellCommandType.Shell, "Connects to an SSH server to execute a command.", True, 3)},
                                                                             {"sumfile", New CommandInfo("sumfile", ShellCommandType.Shell, "Calculates file sums.", True, 2)},
                                                                             {"sumfiles", New CommandInfo("sumfiles", ShellCommandType.Shell, "Calculates sums of files in specified directory.", True, 2)},
                                                                             {"sysinfo", New CommandInfo("sysinfo", ShellCommandType.Shell, "System information", False, 0)},
                                                                             {"unblockdbgdev", New CommandInfo("unblockdbgdev", ShellCommandType.Shell, "Unblock a debug device by IP address", True, 1, True)},
                                                                             {"unzip", New CommandInfo("unzip", ShellCommandType.Shell, "Extracts a ZIP archive", True, 1)},
                                                                             ...
                                                                             {"verify", New CommandInfo("verify", ShellCommandType.Shell, "Verifies sanity of the file", True, 4)},
                                                                             {"weather", New CommandInfo("weather", ShellCommandType.Shell, "Shows weather info for specified city. Uses OpenWeatherMap.", True, 1)},
                                                                             {"wrap", New CommandInfo("wrap", ShellCommandType.Shell, "Wraps the console output", True, 1)},
                                                                             {"zip", New CommandInfo("zip", ShellCommandType.Shell, "Creates a ZIP archive", True, 2)},
                                                                             {"zipshell", New CommandInfo("zipshell", ShellCommandType.Shell, "Opens a ZIP archive", True, 1)}}
