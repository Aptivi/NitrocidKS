...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, "Adds users", "<userName> [password] [confirm]", True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"chlang", New CommandInfo("chlang", ShellCommandType.Shell, "Changes language", "[-alwaystransliterated|-alwaystranslated|-force] <language>", True, 1, New ChLangCommand, True)},
                                                                             ...
                                                                             {"choice", New CommandInfo("choice", ShellCommandType.Shell, "Makes user choices", "[-o|-t|-m|-a] <$variable> <answers> <input>", True, 3, New ChoiceCommand, False, False, False, False, True)},
                                                                             ...
                                                                             {"weather", New CommandInfo("weather", ShellCommandType.Shell, "Shows weather info for specified city. Uses OpenWeatherMap.", "[-list] <CityID/CityName>", True, 1, New WeatherCommand)},
