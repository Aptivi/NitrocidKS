...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellCommandType.Shell, "Adds users", "<userName> [password] [confirm]", True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"choice", New CommandInfo("choice", ShellCommandType.Shell, "Makes user choices", "[-o|-t|-m|-a] <$variable> <answers> <input> [answertitle1] [answertitle2] ...", True, 3, New ChoiceCommand, False, False, False, False, True, New Action(AddressOf (New ChoiceCommand).HelpHelper))},
                                                                             ...
                                                                             {"hwinfo", New CommandInfo("hwinfo", ShellCommandType.Shell, "Prints hardware information", "<HardwareType>", True, 1, New HwInfoCommand, False, True, False, False, True, New Action(AddressOf (New HwInfoCommand).HelpHelper))},
                                                                             ...
                                                                             {"setsaver", New CommandInfo("setsaver", ShellCommandType.Shell, "Sets up kernel screensavers", "<customsaver/builtinsaver>", True, 1, New SetSaverCommand, True, False, False, False, True, New Action(AddressOf (New SetSaverCommand).HelpHelper))},
                                                                             {"setthemes", New CommandInfo("setthemes", ShellCommandType.Shell, "Sets up kernel themes", "<Theme>", True, 1, New SetThemesCommand, False, False, False, False, True, New Action(AddressOf (New SetThemesCommand).HelpHelper))},
                                                                             ...
                                                                             {"showtdzone", New CommandInfo("showtdzone", ShellCommandType.Shell, "Shows date and time in zones", "[-all] <timezone>", True, 1, New ShowTdZoneCommand, False, True)},
                                                                             ...
                                                                             {"speedpress", New CommandInfo("speedpress", ShellCommandType.Shell, "See if you can press a key on time", "[-e|-m|-h|-v|-c] [timeout]", False, 0, New SpeedPressCommand)},
                                                                             ...
                                                                             {"sysinfo", New CommandInfo("sysinfo", ShellCommandType.Shell, "System information", "[-s|-h|-u|-m|-l|-a]", False, 0, New SysInfoCommand)},
                                                                             {"testshell", New CommandInfo("testshell", ShellCommandType.Shell, "Opens a test shell", "", False, 0, New TestShellCommand)},
                                                                             ...
                                                                             {"weather", New CommandInfo("weather", ShellCommandType.Shell, "Shows weather info for specified city. Uses OpenWeatherMap.", "[-list] <CityID/CityName>", True, 1, New WeatherCommand, False, False, False, False, True, New Action(AddressOf (New WeatherCommand).HelpHelper))},
