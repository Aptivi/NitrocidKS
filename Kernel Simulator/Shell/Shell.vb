...
Namespace Shell
    Public Module Shell
        ...
        Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {
            ...
            {"cdbglog", New CommandInfo("cdbglog", ShellType.Shell, "Deletes everything in debug log", New CommandArgumentInfo(), New CdbgLogCommand, True)},
            ...
            {"logout", New CommandInfo("logout", ShellType.Shell, "Logs you out", New CommandArgumentInfo(), New LogoutCommand, False, False, True)},
            ...
            {"lsdbgdev", New CommandInfo("lsdbgdev", ShellType.Shell, "Lists debugging devices connected", New CommandArgumentInfo(), New LsDbgDevCommand, True, True)},
            {"lsvars", New CommandInfo("lsvars", ShellType.Shell, "Lists available UESH variables", New CommandArgumentInfo(), New LsVarsCommand, False, True)},
            ...
            {"netinfo", New CommandInfo("netinfo", ShellType.Shell, "Lists information about all available interfaces", New CommandArgumentInfo(), New NetInfoCommand, True, True)},
            ...
            {"reloadconfig", New CommandInfo("reloadconfig", ShellType.Shell, "Reloads configuration file that is edited.", New CommandArgumentInfo(), New ReloadConfigCommand, True, False, False, False, True)},
            ...
            {"rdebug", New CommandInfo("rdebug", ShellType.Shell, "Enables or disables remote debugging.", New CommandArgumentInfo(), New RdebugCommand, True)},
            ...
            {"savecurrdir", New CommandInfo("savecurrdir", ShellType.Shell, "Saves the current directory to kernel configuration file", New CommandArgumentInfo(), New SaveCurrDirCommand, True)},
            ...
            {"testshell", New CommandInfo("testshell", ShellType.Shell, "Opens a test shell", New CommandArgumentInfo(), New TestShellCommand, True)},
            ...
            {"update", New CommandInfo("update", ShellType.Shell, "System update", New CommandArgumentInfo(), New UpdateCommand, True)},
