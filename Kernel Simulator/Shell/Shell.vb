...
Public Module Shell
    ...
    Public ReadOnly Commands As New Dictionary(Of String, CommandInfo) From {{"adduser", New CommandInfo("adduser", ShellType.Shell, "Adds users", {"<userName> [password] [confirm]"}, True, 1, New AddUserCommand, True)},
                                                                             ...
                                                                             {"settings", New CommandInfo("settings", ShellType.Shell, "Changes kernel configuration", {"[-saver|-splash]"}, False, 0, New SettingsCommand, True, False, False, False, False, New Action(AddressOf (New ShowTdZoneCommand).HelpHelper))},
