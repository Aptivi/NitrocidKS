...
Namespace Shell.Commands
    Class ChHostNameCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgs() As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            If ListArgs(0) = "" Then
                Write(DoTranslation("Blank host name."), True, GetConsoleColor(ColTypes.Error))
            ...
            Else
                Write(DoTranslation("Changing from: {0} to {1}..."), True, color:=GetConsoleColor(ColTypes.Neutral), HostName, ListArgs(0))
