...
namespace KS.Shell.Shells.Text.Commands
{
    ...
    class TextEdit_AddLinesCommand : CommandExecutor, ICommand
    {
        ...
        public override void Execute(string StringArgs, string[] ListArgsOnly, string[] ListSwitchesOnly)
        {
            ...
            TextWriterColor.Write(Translate.DoTranslation("Enter the text that you want to append to the end of the file. When you're done, write \"EOF\" on its own line."), true, ColorTools.ColTypes.Neutral);
            while (FinalLine != "EOF")
            {
