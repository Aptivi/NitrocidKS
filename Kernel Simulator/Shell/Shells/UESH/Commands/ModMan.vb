                                ...
                                For Each ModPart As String In Mods(script).ModParts.Keys
                                    ...
                                    If Mods(script).ModParts(ModPart).PartScript.Commands IsNot Nothing Then
                                        For Each ModCommand As String In Mods(script).ModParts(ModPart).PartScript.Commands.Keys
                                            ...
                                            Write("- " + DoTranslation("Strict command?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.Strict).ToString, True, ColTypes.ListValue)
                                            Write("- " + DoTranslation("Wrappable command?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.Wrappable).ToString, True, ColTypes.ListValue)
                                            Write("- " + DoTranslation("Setting shell variable?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.SettingVariable).ToString, True, ColTypes.ListValue)
                                            Write("- " + DoTranslation("Can not run in maintenance mode?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.NoMaintenance).ToString, True, ColTypes.ListValue)
                                            Write("- " + DoTranslation("Obsolete?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.Obsolete).ToString, True, ColTypes.ListValue)
                                            Write("- " + DoTranslation("Redirection supported?") + " ", False, ColTypes.ListEntry) : Write(Mods(script).ModParts(ModPart).PartScript.Commands(ModCommand).Flags.HasFlag(CommandFlags.RedirectionSupported).ToString, True, ColTypes.ListValue)
