    ...
    Class SshcmdCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            ...
            If AddressDelimiter.Length > 1 Then
                ...
                InitializeSSH(Address, Port, ListArgsOnly(1), ConnectionType.Command, ListArgsOnly(2))
            Else
                InitializeSSH(Address, 22, ListArgsOnly(1), ConnectionType.Command, ListArgsOnly(2))
            End If
        End Sub
