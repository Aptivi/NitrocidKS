...
namespace KS.Shell.Shells.UESH
{
    public static class UESHShellCommon
    {
        ...
        public readonly static Dictionary<string, CommandInfo> Commands = new()
        {
            ...
            { "cat", new CommandInfo("cat", ShellType.Shell, "Prints content of file to console", new CommandArgumentInfo(new[] { "[-lines|-nolines] <file>" }, true, 1), new CatCommand(), CommandFlags.RedirectionSupported | CommandFlags.Wrappable) },
