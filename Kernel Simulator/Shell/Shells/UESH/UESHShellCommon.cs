...
namespace KS.Shell.Shells.UESH
{
    ...
    public static class UESHShellCommon
    {
        ...
        public readonly static Dictionary<string, CommandInfo> Commands = new()
        {
            ...
            { "setthemes", new CommandInfo("setthemes", ShellType.Shell, "Sets up kernel themes", new CommandArgumentInfo(new[] { "<Theme>" }, true, 1), new SetThemesCommand(), CommandFlags.Obsolete) },
            ...
            { "themesel", new CommandInfo("themesel", ShellType.Shell, "Selects a theme and sets it", new CommandArgumentInfo(new[] { "<Theme>" }, true, 1), new ThemeSelCommand()) },
