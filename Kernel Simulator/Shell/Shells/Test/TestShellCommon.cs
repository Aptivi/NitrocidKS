...
namespace KS.Shell.Shells.Test
{
    static class TestShellCommon
    {
        ...
        public readonly static Dictionary<string, CommandInfo> Test_Commands = new Dictionary<string, CommandInfo>()
        {
            ...
            { "checkstrings", new CommandInfo("checkstrings", ShellType.TestShell, "Checks to see if the translatable strings exist in the KS resources", new CommandArgumentInfo(new[] { "<stringlistfile>" }, true, 1), new Test_CheckStringsCommand()) },
