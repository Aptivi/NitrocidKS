...
Imports KS.Shell.Shells.Test.Commands

Namespace Shell.Shells.Test
    Module TestShellCommon
        ...
        Public ReadOnly Test_Commands As New Dictionary(Of String, CommandInfo) From {
            ...
            {"sleeptook", New CommandInfo("sleeptook", ShellType.TestShell, "How many milliseconds did it really take to sleep?", New CommandArgumentInfo({"[-t] <sleepms>"}, True, 1), New Test_SleepTookCommand)},
