...
Imports KS.Shell.Shells.FTP.Commands

Namespace Shell.Shells.FTP
    Public Module FTPShellCommon
        ...
        Public ReadOnly FTPCommands As New Dictionary(Of String, CommandInfo) From {
            ...
            {"disconnect", New CommandInfo("disconnect", ShellType.FTPShell, "Disconnects from server", New CommandArgumentInfo({"[-f]"}, False, 0), New FTP_DisconnectCommand)},
