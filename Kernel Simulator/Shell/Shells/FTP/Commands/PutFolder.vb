...
Namespace Shell.Shells.FTP.Commands
    ...
    Class FTP_PutFolderCommand
        ...
        Public Overrides Sub Execute(StringArgs As String, ListArgsOnly As String(), ListSwitchesOnly As String()) Implements ICommand.Execute
            Dim LocalFolder As String = ListArgsOnly(0)
            Dim RemoteFolder As String = If(ListArgsOnly.Length > 1, ListArgsOnly(1), "")
            Write(DoTranslation("Uploading folder {0}..."), True, ColTypes.Progress, ListArgsOnly(0))
            ...
            If Result Then
                Console.WriteLine()
                Write(NewLine + DoTranslation("Uploaded folder {0}"), True, ColTypes.Success, ListArgsOnly(0))
            Else
                Console.WriteLine()
