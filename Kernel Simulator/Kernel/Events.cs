...
namespace KS.Kernel
{
	public class Events
	{
        ...
        /// </summary>
		internal Dictionary<string, object[]> FiredEvents { get; set; } = new Dictionary<string, object[]>();
		...
		public void RaiseStartKernel()
		{
			...
			FiredEvents.Add("KernelStarted (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaisePreLogin()
		{
			...
			FiredEvents.Add("PreLogin (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			PreLogin?.Invoke();
		}
		/// <summary>
		...
		public void RaisePostLogin(string Username)
		{
			...
			FiredEvents.Add("PostLogin (" + FiredEvents.Count.ToString() + ")", new[] { Username });
		...
		public void RaiseLoginError(string Username, LoginErrorReasons Reason)
		{
			...
			FiredEvents.Add("LoginError (" + FiredEvents.Count.ToString() + ")", new[] { Username, Reason });
		...
		public void RaiseShellInitialized()
		{
			...
			FiredEvents.Add("ShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaisePreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("PreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaisePostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("PostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseKernelError(KernelErrorLevel ErrorType, bool Reboot, long RebootTime, string Description, Exception Exc, object[] Variables)
		{
			...
			FiredEvents.Add("KernelError (" + FiredEvents.Count.ToString() + ")", new[] { ErrorType, Reboot, (object)RebootTime, Description, Exc, Variables });
		...
		public void RaiseContKernelError(KernelErrorLevel ErrorType, bool Reboot, long RebootTime, string Description, Exception Exc, object[] Variables)
		{
			...
			FiredEvents.Add("ContKernelError (" + FiredEvents.Count.ToString() + ")", new[] { ErrorType, Reboot, (object)RebootTime, Description, Exc, Variables });
		...
		public void RaisePreShutdown()
		{
			...
			FiredEvents.Add("PreShutdown (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			PreShutdown?.Invoke();
		}
		/// <summary>
		...
		public void RaisePostShutdown()
		{
			...
			FiredEvents.Add("PostShutdown (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			PostShutdown?.Invoke();
		}
		/// <summary>
		...
		public void RaisePreReboot()
		{
			...
			FiredEvents.Add("PreReboot (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			PreReboot?.Invoke();
		}
		/// <summary>
		...
		public void RaisePostReboot()
		{
			...
			FiredEvents.Add("PostReboot (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			PostReboot?.Invoke();
		}
		/// <summary>
		...
		public void RaisePreShowScreensaver(string Screensaver)
		{
			...
			FiredEvents.Add("PreShowScreensaver (" + FiredEvents.Count.ToString() + ")", new[] { Screensaver });
		...
		public void RaisePostShowScreensaver(string Screensaver)
		{
			...
			FiredEvents.Add("PostShowScreensaver (" + FiredEvents.Count.ToString() + ")", new[] { Screensaver });
		...
		public void RaisePreUnlock(string Screensaver)
		{
			...
			FiredEvents.Add("PreUnlock (" + FiredEvents.Count.ToString() + ")", new[] { Screensaver });
		...
		public void RaisePostUnlock(string Screensaver)
		{
			...
			FiredEvents.Add("PostUnlock (" + FiredEvents.Count.ToString() + ")", new[] { Screensaver });
		...
		public void RaiseCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("CommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaisePreReloadConfig()
		{
			...
			FiredEvents.Add("PreReloadConfig (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaisePostReloadConfig()
		{
			...
			FiredEvents.Add("PostReloadConfig (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaisePlaceholderParsing(string Target)
		{
			...
			FiredEvents.Add("PlaceholderParsing (" + FiredEvents.Count.ToString() + ")", new[] { Target });
		...
		public void RaisePlaceholderParsed(string Target)
		{
			...
			FiredEvents.Add("PlaceholderParsed (" + FiredEvents.Count.ToString() + ")", new[] { Target });
		...
		public void RaisePlaceholderParseError(string Target, Exception Exception)
		{
			...
			FiredEvents.Add("PlaceholderParseError (" + FiredEvents.Count.ToString() + ")", new[] { Target, Exception });
		...
		public void RaiseGarbageCollected()
		{
			...
			FiredEvents.Add("GarbageCollected (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseFTPShellInitialized()
		{
			...
			FiredEvents.Add("FTPShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseFTPPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("FTPPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseFTPPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("FTPPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseFTPCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("FTPCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseFTPPreDownload(string File)
		{
			...
			FiredEvents.Add("FTPPreDownload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseFTPPostDownload(string File, bool Success)
		{
			...
			FiredEvents.Add("FTPPostDownload (" + FiredEvents.Count.ToString() + ")", new[] { File, (object)Success });
		...
		public void RaiseFTPPreUpload(string File)
		{
			...
			FiredEvents.Add("FTPPreUpload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseFTPPostUpload(string File, bool Success)
		{
			...
			FiredEvents.Add("FTPPostUpload (" + FiredEvents.Count.ToString() + ")", new[] { File, (object)Success });
		...
		public void RaiseIMAPShellInitialized()
		{
			...
			FiredEvents.Add("IMAPShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseIMAPPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("IMAPPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseIMAPPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("IMAPPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseIMAPCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("IMAPCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseRemoteDebugConnectionAccepted(string IP)
		{
			...
			FiredEvents.Add("RemoteDebugConnectionAccepted (" + FiredEvents.Count.ToString() + ")", new[] { IP });
		...
		public void RaiseRemoteDebugConnectionDisconnected(string IP)
		{
			...
			FiredEvents.Add("RemoteDebugConnectionDisconnected (" + FiredEvents.Count.ToString() + ")", new[] { IP });
		...
		public void RaiseRemoteDebugExecuteCommand(string IP, string Command)
		{
			...
			FiredEvents.Add("RemoteDebugExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { IP, Command });
		...
		public void RaiseRemoteDebugCommandError(string IP, string Command, Exception Exception)
		{
			...
			FiredEvents.Add("RemoteDebugCommandError (" + FiredEvents.Count.ToString() + ")", new[] { IP, Command, Exception });
		...
		public void RaiseRPCCommandSent(string Command, string Argument, string IP, int Port)
		{
			...
			FiredEvents.Add("RPCCommandSent (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseRPCCommandReceived(string Command, string IP, int Port)
		{
			...
			FiredEvents.Add("RPCCommandReceived (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseRPCCommandError(string Command, Exception Exception, string IP, int Port)
		{
			...
			FiredEvents.Add("RPCCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseRSSShellInitialized(string FeedUrl)
		{
			...
			FiredEvents.Add("RSSShellInitialized (" + FiredEvents.Count.ToString() + ")", new[] { FeedUrl });
		...
		public void RaiseRSSPreExecuteCommand(string FeedUrl, string Command)
		{
			...
			FiredEvents.Add("RSSPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { FeedUrl, Command });
		...
		public void RaiseRSSPostExecuteCommand(string FeedUrl, string Command)
		{
			...
			FiredEvents.Add("RSSPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { FeedUrl, Command });
		...
		public void RaiseRSSCommandError(string FeedUrl, string Command, Exception Exception)
		{
			...
			FiredEvents.Add("RSSCommandError (" + FiredEvents.Count.ToString() + ")", new[] { FeedUrl, Command, Exception });
		...
		public void RaiseSFTPShellInitialized()
		{
			...
			FiredEvents.Add("SFTPShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseSFTPPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("SFTPPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseSFTPPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("SFTPPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseSFTPCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("SFTPCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseSFTPPreDownload(string File)
		{
			...
			FiredEvents.Add("SFTPPreDownload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseSFTPPostDownload(string File)
		{
			...
			FiredEvents.Add("SFTPPostDownload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseSFTPDownloadError(string File, Exception Exception)
		{
			...
			FiredEvents.Add("SFTPDownloadError (" + FiredEvents.Count.ToString() + ")", new[] { File, Exception });
		...
		public void RaiseSFTPPreUpload(string File)
		{
			...
			FiredEvents.Add("SFTPPreUpload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseSFTPPostUpload(string File)
		{
			...
			FiredEvents.Add("SFTPPostUpload (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseSFTPUploadError(string File, Exception Exception)
		{
			...
			FiredEvents.Add("SFTPUploadError (" + FiredEvents.Count.ToString() + ")", new[] { File, Exception });
		...
		public void RaiseSSHConnected(string Target)
		{
			...
			FiredEvents.Add("SSHConnected (" + FiredEvents.Count.ToString() + ")", new[] { Target });
		...
		public void RaiseSSHDisconnected()
		{
			...
			FiredEvents.Add("SSHDisconnected (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseSSHPreExecuteCommand(string Target, string Command)
		{
			...
			FiredEvents.Add("SSHPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseSSHPostExecuteCommand(string Target, string Command)
		{
			...
			FiredEvents.Add("SSHPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseSSHCommandError(string Target, string Command, Exception Exception)
		{
			...
			FiredEvents.Add("SSHCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseSSHError(Exception Exception)
		{
			...
			FiredEvents.Add("SSHError (" + FiredEvents.Count.ToString() + ")", new[] { Exception });
		...
		public void RaiseUESHPreExecute(string Command, string Arguments)
		{
			...
			FiredEvents.Add("UESHPreExecute (" + FiredEvents.Count.ToString() + ")", new[] { Command, Arguments });
		...
		public void RaiseUESHPostExecute(string Command, string Arguments)
		{
			...
			FiredEvents.Add("UESHPostExecute (" + FiredEvents.Count.ToString() + ")", new[] { Command, Arguments });
		...
		public void RaiseUESHError(string Command, string Arguments, Exception Exception)
		{
			...
			FiredEvents.Add("UESHError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Arguments, Exception });
		...
		public void RaiseTextShellInitialized()
		{
			...
			FiredEvents.Add("TextShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseTextPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("TextPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseTextPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("TextPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseTextCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("TextCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseNotificationSent(Notification Notification)
		{
			...
			FiredEvents.Add("NotificationSent (" + FiredEvents.Count.ToString() + ")", new[] { Notification });
		...
		public void RaiseNotificationsSent(List<Notification> Notifications)
		{
			...
			FiredEvents.Add("NotificationsSent (" + FiredEvents.Count.ToString() + ")", new[] { Notifications });
		...
		public void RaiseNotificationReceived(Notification Notification)
		{
			...
			FiredEvents.Add("NotificationReceived (" + FiredEvents.Count.ToString() + ")", new[] { Notification });
		...
		public void RaiseNotificationsReceived(List<Notification> Notifications)
		{
			...
			FiredEvents.Add("NotificationsReceived (" + FiredEvents.Count.ToString() + ")", new[] { Notifications });
		...
		public void RaiseNotificationDismissed()
		{
			...
			FiredEvents.Add("NotificationDismissed (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseConfigSaved()
		{
			...
			FiredEvents.Add("ConfigSaved (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			ConfigSaved?.Invoke();
		}
		/// <summary>
		...
		public void RaiseConfigSaveError(Exception Exception)
		{
			...
			FiredEvents.Add("ConfigSaveError (" + FiredEvents.Count.ToString() + ")", new[] { Exception });
		...
		public void RaiseConfigRead()
		{
			...
			FiredEvents.Add("ConfigRead (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			ConfigRead?.Invoke();
		}
		/// <summary>
		...
		public void RaiseConfigReadError(Exception Exception)
		{
			...
			FiredEvents.Add("ConfigReadError (" + FiredEvents.Count.ToString() + ")", new[] { Exception });
		...
		public void RaisePreExecuteModCommand(string Command)
		{
			...
			FiredEvents.Add("PreExecuteModCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaisePostExecuteModCommand(string Command)
		{
			...
			FiredEvents.Add("PostExecuteModCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseModParsed(string ModFileName)
		{
			...
			FiredEvents.Add("ModParsed (" + FiredEvents.Count.ToString() + ")", new[] { ModFileName });
		...
		public void RaiseModParseError(string ModFileName)
		{
			...
			FiredEvents.Add("ModParseError (" + FiredEvents.Count.ToString() + ")", new[] { ModFileName });
		...
		public void RaiseModFinalized(string ModFileName)
		{
			...
			FiredEvents.Add("ModFinalized (" + FiredEvents.Count.ToString() + ")", new[] { ModFileName });
		...
		public void RaiseModFinalizationFailed(string ModFileName, string Reason)
		{
			...
			FiredEvents.Add("ModFinalizationFailed (" + FiredEvents.Count.ToString() + ")", new[] { ModFileName, Reason });
		...
		public void RaiseUserAdded(string Username)
		{
			...
			FiredEvents.Add("UserAdded (" + FiredEvents.Count.ToString() + ")", new[] { Username });
		...
		public void RaiseUserRemoved(string Username)
		{
			...
			FiredEvents.Add("UserRemoved (" + FiredEvents.Count.ToString() + ")", new[] { Username });
		...
		public void RaiseUsernameChanged(string OldUsername, string NewUsername)
		{
			...
			FiredEvents.Add("UsernameChanged (" + FiredEvents.Count.ToString() + ")", new[] { OldUsername, NewUsername });
		...
		public void RaiseUserPasswordChanged(string Username)
		{
			...
			FiredEvents.Add("UserPasswordChanged (" + FiredEvents.Count.ToString() + ")", new[] { Username });
		...
		public void RaiseHardwareProbing()
		{
			...
			FiredEvents.Add("HardwareProbing (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseHardwareProbed()
		{
			...
			FiredEvents.Add("HardwareProbed (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseCurrentDirectoryChanged()
		{
			...
			FiredEvents.Add("CurrentDirectoryChanged (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseFileCreated(string File)
		{
			...
			FiredEvents.Add("FileCreated (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseDirectoryCreated(string Directory)
		{
			...
			FiredEvents.Add("DirectoryCreated (" + FiredEvents.Count.ToString() + ")", new[] { Directory });
		...
		public void RaiseFileCopied(string Source, string Destination)
		{
			...
			FiredEvents.Add("FileCopied (" + FiredEvents.Count.ToString() + ")", new[] { Source, Destination });
		...
		public void RaiseDirectoryCopied(string Source, string Destination)
		{
			...
			FiredEvents.Add("DirectoryCopied (" + FiredEvents.Count.ToString() + ")", new[] { Source, Destination });
		...
		public void RaiseFileMoved(string Source, string Destination)
		{
			...
			FiredEvents.Add("FileMoved (" + FiredEvents.Count.ToString() + ")", new[] { Source, Destination });
		...
		public void RaiseDirectoryMoved(string Source, string Destination)
		{
			...
			FiredEvents.Add("DirectoryMoved (" + FiredEvents.Count.ToString() + ")", new[] { Source, Destination });
		...
		public void RaiseFileRemoved(string File)
		{
			...
			FiredEvents.Add("FileRemoved (" + FiredEvents.Count.ToString() + ")", new[] { File });
		...
		public void RaiseDirectoryRemoved(string Directory)
		{
			...
			FiredEvents.Add("DirectoryRemoved (" + FiredEvents.Count.ToString() + ")", new[] { Directory });
		...
		public void RaiseFileAttributeAdded(string File, FileAttributes Attributes)
		{
			...
			FiredEvents.Add("FileAttributeAdded (" + FiredEvents.Count.ToString() + ")", new[] { File, Attributes });
		...
		public void RaiseFileAttributeRemoved(string File, FileAttributes Attributes)
		{
			...
			FiredEvents.Add("FileAttributeRemoved (" + FiredEvents.Count.ToString() + ")", new[] { File, Attributes });
		...
		public void RaiseColorReset()
		{
			...
			FiredEvents.Add("ColorReset (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			ColorReset?.Invoke();
		}
		/// <summary>
		...
		public void RaiseThemeSet(string Theme)
		{
			...
			FiredEvents.Add("ThemeSet (" + FiredEvents.Count.ToString() + ")", new[] { Theme });
		...
		public void RaiseThemeSetError(string Theme, ThemeSetErrorReasons Reason)
		{
			...
			FiredEvents.Add("ThemeSetError (" + FiredEvents.Count.ToString() + ")", new[] { Theme, Reason });
		...
		public void RaiseColorSet()
		{
			...
			FiredEvents.Add("ColorSet (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
			ColorSet?.Invoke();
		}
		/// <summary>
		...
		public void RaiseColorSetError(ColorSetErrorReasons Reason)
		{
			...
			FiredEvents.Add("ColorSetError (" + FiredEvents.Count.ToString() + ")", new[] { Reason });
		...
		public void RaiseThemeStudioStarted()
		{
			...
			FiredEvents.Add("ThemeStudioStarted (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseThemeStudioExit()
		{
			...
			FiredEvents.Add("ThemeStudioExit (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseArgumentsInjected(List<string> InjectedArguments)
		{
			...
			FiredEvents.Add("ArgumentsInjected (" + FiredEvents.Count.ToString() + ")", new[] { InjectedArguments });
		...
		public void RaiseZipShellInitialized()
		{
			...
			FiredEvents.Add("ZipShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseZipPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("ZipPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseZipPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("ZipPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseZipCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("ZipCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseHTTPShellInitialized()
		{
			...
			FiredEvents.Add("HTTPShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseHTTPPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("HTTPPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseHTTPPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("HTTPPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseHTTPCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("HTTPCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseProcessError(string Process, Exception Exception)
		{
			...
			FiredEvents.Add("ProcessError (" + FiredEvents.Count.ToString() + ")", new[] { Process, Exception });
		...
		public void RaiseLanguageInstalled(string Language)
		{
			...
			FiredEvents.Add("LanguageInstalled (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguageUninstalled(string Language)
		{
			...
			FiredEvents.Add("LanguageUninstalled (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguageInstallError(string Language, Exception Exception)
		{
			...
			FiredEvents.Add("LanguageInstallError (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguageUninstallError(string Language, Exception Exception)
		{
			...
			FiredEvents.Add("LanguageUninstallError (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguagesInstalled()
		{
			...
			FiredEvents.Add("LanguagesInstalled (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguagesUninstalled()
		{
			...
			FiredEvents.Add("LanguagesUninstalled (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguagesInstallError(Exception Exception)
		{
			...
			FiredEvents.Add("LanguagesInstallError (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseLanguagesUninstallError(Exception Exception)
		{
			...
			FiredEvents.Add("LanguagesUninstallError (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseHexShellInitialized()
		{
			...
			FiredEvents.Add("HexShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseHexPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("HexPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseHexPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("HexPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseHexCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("HexCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseJsonShellInitialized()
		{
			...
			FiredEvents.Add("JsonShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseJsonPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("JsonPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseJsonPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("JsonPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseJsonCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("JsonCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseTestShellInitialized()
		{
			...
			FiredEvents.Add("TestShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseTestPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("TestPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseTestPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("TestPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseTestCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("TestCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
		...
		public void RaiseRarShellInitialized()
		{
			...
			FiredEvents.Add("RarShellInitialized (" + FiredEvents.Count.ToString() + ")", Array.Empty<object>());
		...
		public void RaiseRarPreExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("RarPreExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseRarPostExecuteCommand(string Command)
		{
			...
			FiredEvents.Add("RarPostExecuteCommand (" + FiredEvents.Count.ToString() + ")", new[] { Command });
		...
		public void RaiseRarCommandError(string Command, Exception Exception)
		{
			...
			FiredEvents.Add("RarCommandError (" + FiredEvents.Count.ToString() + ")", new[] { Command, Exception });
