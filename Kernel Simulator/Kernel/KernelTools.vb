...
#End If
    ...
    Sub CheckKernelUpdates()
        ...
        Try
            ...
            Dim UpdateVer As String = UpdateToken.First.SelectToken("tag_name").ToString.ReplaceAll({"v", "-alpha", "-beta"}, "")
            Dim UpdateURL As String = UpdateToken.First.SelectToken("html_url")
            Dim CurrentVer As New Version(KernelVersion)
            Dim UpdatedVer As New Version(UpdateVer)
            If UpdatedVer > CurrentVer Then
                'Found a new version
