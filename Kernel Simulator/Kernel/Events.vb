...
Public Class Events
    ...
    Public Sub RaiseStartKernel()
        Wdbg(DebugLevel.I, "Raising event KernelStarted() and responding in RespondStartKernel()...")
    ...
    Public Sub RaisePreLogin()
        Wdbg(DebugLevel.I, "Raising event PreLogin() and responding in RespondPreLogin()...")
    ...
    Public Sub RaisePostLogin(Username As String)
        Wdbg(DebugLevel.I, "Raising event PostLogin() and responding in RespondPostLogin()...")
    ...
    Public Sub RaiseShellInitialized()
        Wdbg(DebugLevel.I, "Raising event ShellInitialized() and responding in RespondShellInitialized()...")
    ...
    Public Sub RaisePreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event PreExecuteCommand() and responding in RespondPreExecuteCommand()...")
    ...
    Public Sub RaisePostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event PostExecuteCommand() and responding in RespondPostExecuteCommand()...")
    ...
    Public Sub RaisePreShutdown()
        Wdbg(DebugLevel.I, "Raising event PreShutdown() and responding in RespondPreShutdown()...")
    ...
    Public Sub RaisePostShutdown()
        Wdbg(DebugLevel.I, "Raising event PostShutdown() and responding in RespondPostShutdown()...")
    ...
    Public Sub RaisePreReboot()
        Wdbg(DebugLevel.I, "Raising event PreReboot() and responding in RespondPreReboot()...")
    ...
    Public Sub RaisePostReboot()
        Wdbg(DebugLevel.I, "Raising event PostReboot() and responding in RespondPostReboot()...")
    ...
    Public Sub RaisePreShowScreensaver(Screensaver As String)
        Wdbg(DebugLevel.I, "Raising event PreShowScreensaver() and responding in RespondPreShowScreensaver()...")
    ...
    Public Sub RaisePostShowScreensaver(Screensaver As String)
        Wdbg(DebugLevel.I, "Raising event PostShowScreensaver() and responding in RespondPostShowScreensaver()...")
    ...
    Public Sub RaisePreUnlock(Screensaver As String)
        Wdbg(DebugLevel.I, "Raising event PreUnlock() and responding in RespondPreUnlock()...")
    ...
    Public Sub RaisePostUnlock(Screensaver As String)
        Wdbg(DebugLevel.I, "Raising event PostUnlock() and responding in RespondPostUnlock()...")
    ...
    Public Sub RaiseCommandError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event CommandError() and responding in RespondCommandError()...")
    ...
    Public Sub RaisePreReloadConfig()
        Wdbg(DebugLevel.I, "Raising event PreReloadConfig() and responding in RespondPreReloadConfig()...")
    ...
    Public Sub RaisePostReloadConfig()
        Wdbg(DebugLevel.I, "Raising event PostReloadConfig() and responding in RespondPostReloadConfig()...")
    ...
    Public Sub RaisePlaceholderParsing(Target As String)
        Wdbg(DebugLevel.I, "Raising event PlaceholderParsing() and responding in RespondPlaceholderParsing()...")
    ...
    Public Sub RaisePlaceholderParsed(Target As String)
        Wdbg(DebugLevel.I, "Raising event PlaceholderParsed() and responding in RespondPlaceholderParsed()...")
    ...
    Public Sub RaiseGarbageCollected()
        Wdbg(DebugLevel.I, "Raising event GarbageCollected() and responding in RespondGarbageCollected()...")
    ...
    Public Sub RaiseFTPShellInitialized()
        Wdbg(DebugLevel.I, "Raising event FTPShellInitialized() and responding in RespondFTPShellInitialized()...")
    ...
    Public Sub RaiseFTPPreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event FTPPreExecuteCommand() and responding in RespondFTPPreExecuteCommand()...")
    ...
    Public Sub RaiseFTPPostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event FTPPostExecuteCommand() and responding in RespondFTPPostExecuteCommand()...")
    ...
    Public Sub RaiseFTPCommandError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event FTPCommandError() and responding in RespondFTPCommandError()...")
    ...
    Public Sub RaiseFTPPreDownload(File As String)
        Wdbg(DebugLevel.I, "Raising event FTPPreDownload() and responding in RespondFTPPreDownload()...")
    ...
    Public Sub RaiseFTPPostDownload(File As String, Success As Boolean)
        Wdbg(DebugLevel.I, "Raising event FTPPostDownload() and responding in RespondFTPPostDownload()...")
    ...
    Public Sub RaiseFTPPreUpload(File As String)
        Wdbg(DebugLevel.I, "Raising event FTPPreUpload() and responding in RespondFTPPreUpload()...")
    ...
    Public Sub RaiseFTPPostUpload(File As String, Success As Boolean)
        Wdbg(DebugLevel.I, "Raising event FTPPostUpload() and responding in RespondFTPPostUpload()...")
    ...
    Public Sub RaiseIMAPShellInitialized()
        Wdbg(DebugLevel.I, "Raising event IMAPShellInitialized() and responding in RespondIMAPShellInitialized()...")
    ...
    Public Sub RaiseIMAPPreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event IMAPPreExecuteCommand() and responding in RespondIMAPPreExecuteCommand()...")
    ...
    Public Sub RaiseIMAPPostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event IMAPPostExecuteCommand() and responding in RespondIMAPPostExecuteCommand()...")
    ...
    Public Sub RaiseIMAPCommandError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event IMAPCommandError() and responding in RespondIMAPCommandError()...")
    ...
    Public Sub RaiseRemoteDebugConnectionAccepted(IP As String)
        Wdbg(DebugLevel.I, "Raising event RemoteDebugConnectionAccepted() and responding in RespondRemoteDebugConnectionAccepted()...")
    ...
    Public Sub RaiseRemoteDebugConnectionDisconnected(IP As String)
        Wdbg(DebugLevel.I, "Raising event RemoteDebugConnectionDisconnected() and responding in RespondRemoteDebugConnectionDisconnected()...")
    ...
    Public Sub RaiseRemoteDebugExecuteCommand(IP As String, Command As String)
        Wdbg(DebugLevel.I, "Raising event RemoteDebugExecuteCommand() and responding in RespondRemoteDebugExecuteCommand()...")
    ...
    Public Sub RaiseRemoteDebugCommandError(IP As String, Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event RemoteDebugCommandError() and responding in RespondRemoteDebugCommandError()...")
    ...
    Public Sub RaiseRSSShellInitialized(FeedUrl As String)
        Wdbg(DebugLevel.I, "Raising event RSSShellInitialized() and responding in RespondRSSShellInitialized()...")
    ...
    Public Sub RaiseRSSPreExecuteCommand(FeedUrl As String, Command As String)
        Wdbg(DebugLevel.I, "Raising event RSSPreExecuteCommand() and responding in RespondRSSPreExecuteCommand()...")
    ...
    Public Sub RaiseRSSPostExecuteCommand(FeedUrl As String, Command As String)
        Wdbg(DebugLevel.I, "Raising event RSSPostExecuteCommand() and responding in RespondRSSPostExecuteCommand()...")
    ...
    Public Sub RaiseRSSCommandError(FeedUrl As String, Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event RSSCommandError() and responding in RespondRSSCommandError()...")
    ...
    Public Sub RaiseSFTPShellInitialized()
        Wdbg(DebugLevel.I, "Raising event SFTPShellInitialized() and responding in RespondSFTPShellInitialized()...")
    ...
    Public Sub RaiseSFTPPreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPreExecuteCommand() and responding in RespondSFTPPreExecuteCommand()...")
    ...
    Public Sub RaiseSFTPPostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPostExecuteCommand() and responding in RespondSFTPPostExecuteCommand()...")
    ...
    Public Sub RaiseSFTPCommandError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event SFTPCommandError() and responding in RespondSFTPCommandError()...")
    ...
    Public Sub RaiseSFTPPreDownload(File As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPreDownload() and responding in RespondSFTPPreDownload()...")
    ...
    Public Sub RaiseSFTPPostDownload(File As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPostDownload() and responding in RespondSFTPPostDownload()...")
    ...
    Public Sub RaiseSFTPDownloadError(File As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event SFTPDownloadError() and responding in RespondSFTPDownloadError()...")
    ...
    Public Sub RaiseSFTPPreUpload(File As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPreUpload() and responding in RespondSFTPPreUpload()...")
    ...
    Public Sub RaiseSFTPPostUpload(File As String)
        Wdbg(DebugLevel.I, "Raising event SFTPPostUpload() and responding in RespondSFTPPostUpload()...")
    ...
    Public Sub RaiseSFTPUploadError(File As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event SFTPUploadError() and responding in RespondSFTPUploadError()...")
    ...
    Public Sub RaiseSSHConnected(Target As String)
        Wdbg(DebugLevel.I, "Raising event SSHConnected() and responding in RespondSSHConnected()...")
    ...
    Public Sub RaiseSSHDisconnected()
        Wdbg(DebugLevel.I, "Raising event SSHDisconnected() and responding in RespondSSHDisconnected()...")
    ...
    Public Sub RaiseSSHPreExecuteCommand(Target As String, Command As String)
        Wdbg(DebugLevel.I, "Raising event SSHPreExecuteCommand() and responding in RespondSSHPreExecuteCommand()...")
    ...
    Public Sub RaiseSSHPostExecuteCommand(Target As String, Command As String)
        Wdbg(DebugLevel.I, "Raising event SSHPostExecuteCommand() and responding in RespondSSHPostExecuteCommand()...")
    ...
    Public Sub RaiseSSHCommandError(Target As String, Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event SSHCommandError() and responding in RespondSSHCommandError()...")
    ...
    Public Sub RaiseSSHError(Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event SSHError() and responding in RespondSSHError()...")
    ...
    Public Sub RaiseUESHPreExecute(Command As String)
        Wdbg(DebugLevel.I, "Raising event UESHPreExecute() and responding in RespondUESHPreExecute()...")
    ...
    Public Sub RaiseUESHPostExecute(Command As String)
        Wdbg(DebugLevel.I, "Raising event UESHPostExecute() and responding in RespondUESHPostExecute()...")
    ...
    Public Sub RaiseUESHError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event UESHError() and responding in RespondUESHError()...")
    ...
    Public Sub RaiseTextShellInitialized()
        Wdbg(DebugLevel.I, "Raising event TextShellInitialized() and responding in RespondTextShellInitialized()...")
    ...
    Public Sub RaiseTextPreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event TextPreExecuteCommand() and responding in RespondTextPreExecuteCommand()...")
    ...
    Public Sub RaiseTextPostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event TextPostExecuteCommand() and responding in RespondTextPostExecuteCommand()...")
    ...
    Public Sub RaiseTextCommandError(Command As String, Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event TextCommandError() and responding in RespondTextCommandError()...")
    ...
    Public Sub RaiseNotificationSent(Notification As Notification)
        Wdbg(DebugLevel.I, "Raising event NotificationSent() and responding in RespondNotificationSent()...")
    ...
    Public Sub RaiseNotificationsSent(Notifications As List(Of Notification))
        Wdbg(DebugLevel.I, "Raising event NotificationsSent() and responding in RespondNotificationsSent()...")
    ...
    Public Sub RaiseNotificationReceived(Notification As Notification)
        Wdbg(DebugLevel.I, "Raising event NotificationReceived() and responding in RespondNotificationReceived()...")
    ...
    Public Sub RaiseNotificationsReceived(Notifications As List(Of Notification))
        Wdbg(DebugLevel.I, "Raising event NotificationsReceived() and responding in RespondNotificationsReceived()...")
    ...
    Public Sub RaiseNotificationDismissed()
        Wdbg(DebugLevel.I, "Raising event NotificationDismissed() and responding in RespondNotificationDismissed()...")
    ...
    Public Sub RaiseConfigSaved()
        Wdbg(DebugLevel.I, "Raising event ConfigSaved() and responding in RespondConfigSaved()...")
    ...
    Public Sub RaiseConfigSaveError(Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event ConfigSaveError() and responding in RespondConfigSaveError()...")
    ...
    Public Sub RaiseConfigRead()
        Wdbg(DebugLevel.I, "Raising event ConfigRead() and responding in RespondConfigRead()...")
    ...
    Public Sub RaiseConfigReadError(Exception As Exception)
        Wdbg(DebugLevel.I, "Raising event ConfigReadError() and responding in RespondConfigReadError()...")
    ...
    Public Sub RaisePreExecuteModCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event PreExecuteModCommand() and responding in RespondPreExecuteModCommand()...")
    ...
    Public Sub RaisePostExecuteModCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event PostExecuteModCommand() and responding in RespondPostExecuteModCommand()...")
    ...
    Public Sub RaiseModParsed(ModFileName As String)
        Wdbg(DebugLevel.I, "Raising event ModParsed() and responding in RespondModParsed()...")
    ...
    Public Sub RaiseModParseError(ModFileName As String)
        Wdbg(DebugLevel.I, "Raising event ModParseError() and responding in RespondModParseError()...")
    ...
    Public Sub RaiseModFinalized(ModFileName As String)
        Wdbg(DebugLevel.I, "Raising event ModFinalized() and responding in RespondModFinalized()...")
    ...
    Public Sub RaiseModFinalizationFailed(ModFileName As String, Reason As String)
        Wdbg(DebugLevel.I, "Raising event ModFinalizationFailed() and responding in RespondModFinalizationFailed()...")
    ...
    Public Sub RaiseUserAdded(Username As String)
        Wdbg(DebugLevel.I, "Raising event UserAdded() and responding in RespondUserAdded()...")
    ...
    Public Sub RaiseUserRemoved(Username As String)
        Wdbg(DebugLevel.I, "Raising event UserRemoved() and responding in RespondUserRemoved()...")
    ...
    Public Sub RaiseUsernameChanged(OldUsername As String, NewUsername As String)
        Wdbg(DebugLevel.I, "Raising event UsernameChanged() and responding in RespondUsernameChanged()...")
    ...
    Public Sub RaiseUserPasswordChanged(Username As String)
        Wdbg(DebugLevel.I, "Raising event UserPasswordChanged() and responding in RespondUserPasswordChanged()...")
    ...
    Public Sub RaiseHardwareProbing()
        Wdbg(DebugLevel.I, "Raising event HardwareProbing() and responding in RespondHardwareProbing()...")
    ...
    Public Sub RaiseHardwareProbed()
        Wdbg(DebugLevel.I, "Raising event HardwareProbed() and responding in RespondHardwareProbed()...")
    ...
    Public Sub RaiseCurrentDirectoryChanged()
        Wdbg(DebugLevel.I, "Raising event CurrentDirectoryChanged() and responding in RespondCurrentDirectoryChanged()...")
    ...
    Public Sub RaiseFileCreated(File As String)
        Wdbg(DebugLevel.I, "Raising event FileCreated() and responding in RespondFileCreated()...")
    ...
    Public Sub RaiseDirectoryCreated(Directory As String)
        Wdbg(DebugLevel.I, "Raising event DirectoryCreated() and responding in RespondDirectoryCreated()...")
    ...
    Public Sub RaiseFileCopied(Source As String, Destination As String)
        Wdbg(DebugLevel.I, "Raising event FileCopied() and responding in RespondFileCopied()...")
    ...
    Public Sub RaiseDirectoryCopied(Source As String, Destination As String)
        Wdbg(DebugLevel.I, "Raising event DirectoryCopied() and responding in RespondDirectoryCopied()...")
    ...
    Public Sub RaiseFileMoved(Source As String, Destination As String)
        Wdbg(DebugLevel.I, "Raising event FileMoved() and responding in RespondFileMoved()...")
    ...
    Public Sub RaiseDirectoryMoved(Source As String, Destination As String)
        Wdbg(DebugLevel.I, "Raising event DirectoryMoved() and responding in RespondDirectoryMoved()...")
    ...
    Public Sub RaiseFileRemoved(File As String)
        Wdbg(DebugLevel.I, "Raising event FileRemoved() and responding in RespondFileRemoved()...")
    ...
    Public Sub RaiseDirectoryRemoved(Directory As String)
        Wdbg(DebugLevel.I, "Raising event DirectoryRemoved() and responding in RespondDirectoryRemoved()...")
    ...
    Public Sub RaiseFileAttributeAdded(File As String, Attributes As FileAttributes)
        Wdbg(DebugLevel.I, "Raising event FileAttributeAdded() and responding in RespondFileAttributeAdded()...")
    ...
    Public Sub RaiseFileAttributeRemoved(File As String, Attributes As FileAttributes)
        Wdbg(DebugLevel.I, "Raising event FileAttributeRemoved() and responding in RespondFileAttributeRemoved()...")
    ...
    Public Sub RaiseColorReset()
        Wdbg(DebugLevel.I, "Raising event ColorReset() and responding in RespondColorReset()...")
    ...
    Public Sub RaiseThemeSet(Theme As String)
        Wdbg(DebugLevel.I, "Raising event ThemeSet() and responding in RespondThemeSet()...")
    ...
    Public Sub RaiseColorSet()
        Wdbg(DebugLevel.I, "Raising event ColorSet() and responding in RespondColorSet()...")
    ...
    Public Sub RaiseThemeStudioStarted()
        Wdbg(DebugLevel.I, "Raising event ThemeStudioStarted() and responding in RespondThemeStudioStarted()...")
    ...
    Public Sub RaiseThemeStudioExit()
        Wdbg(DebugLevel.I, "Raising event ThemeStudioExit() and responding in RespondThemeStudioExit()...")
    ...
    Public Sub RaiseArgumentsInjected(InjectedArguments As List(Of String))
        Wdbg(DebugLevel.I, "Raising event ArgumentsInjected() and responding in RespondArgumentsInjected()...")
    ...
    Public Sub RaiseZipShellInitialized()
        Wdbg(DebugLevel.I, "Raising event ZipShellInitialized() and responding in RespondZipShellInitialized()...")
    ...
    Public Sub RaiseZipPreExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event ZipPreExecuteCommand() and responding in RespondZipPreExecuteCommand()...")
    ...
    Public Sub RaiseZipPostExecuteCommand(Command As String)
        Wdbg(DebugLevel.I, "Raising event ZipPostExecuteCommand() and responding in RespondZipPostExecuteCommand()...")
