        ...
        Public Sub ViewPage(ManualTitle As String)
            If Pages.Keys.Contains(ManualTitle) Then
                ...
                If Pages(ManualTitle).Todos.Count <> 0 Then
                    ...
                    TextWriterColor.Write(DoTranslation("This manual page needs work for:") + NewLine, True, ColTypes.Warning)
                    WriteList(Pages(ManualTitle).Todos, True)
                    TextWriterColor.Write(NewLine + DoTranslation("Press any key to read the manual page..."), False, ColTypes.Warning)
                    Console.ReadKey()
                End If
                ...
                For Each line As String In IncompleteSentences
                    ...
                    TextWriterColor.Write(line, True, ColTypes.Neutral)
                ...
                Console.Clear()
            Else
                TextWriterColor.Write(DoTranslation("Manual page {0} not found."), True, ColTypes.Neutral, ManualTitle)
            End If
        End Sub
