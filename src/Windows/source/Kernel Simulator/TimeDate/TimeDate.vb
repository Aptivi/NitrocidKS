...
Module TimeDate
    ...
    Sub ShowTime()
        ...
        System.Console.WriteLine("datetime: Time is {0}", FormatDateTime(strKernelTimeDate, DateFormat.LongTime))
        System.Console.WriteLine("datetime: Today is {0}", FormatDateTime(strKernelTimeDate, DateFormat.LongDate))
